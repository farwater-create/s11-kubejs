ServerEvents.recipes(event => {
    ...
    event.recipes.create.splashing(
		[
			...
			CreateItem.of('7x minecraft:iron_nugget', 0.57),
			CreateItem.of('minecraft:redstone', 0.75)
		],
		'create:crushed_raw_iron'
	); 
    event.recipes.create.splashing(
		[
			Item.of('minecraft:gold_nugget', 10),
			CreateItem.of('7x minecraft:gold_nugget', 0.57),
			CreateItem.of('minecraft:quartz', 0.75)
		],
		'create:crushed_raw_gold'
	);
    event.recipes.create.splashing(
		[
			Item.of('create:copper_nugget', 10),
			CreateItem.of('7x create:copper_nugget', 0.57),
    ...
    event.recipes.create.splashing(
		[
			Item.of('create:zinc_nugget', 10),
			CreateItem.of('7x create:zinc_nugget', 0.57),
	...
	event.recipes.create.milling([Item.of('minecraft:wheat_seeds'), CreateItem.of('minecraft:green_dye', 0.08)], 'minecraft:short_grass');
});
