...
declare module "@package/net/neoforged/neoforge/common/crafting" {
    ...
    export class $DataComponentIngredient implements $ICustomIngredient {
        ...
        static of<T>(arg0: boolean, arg1: $DataComponentType<T>, arg2: T, ...arg3: $ItemLike_[]): $Ingredient;
        /**
     ...
     */
    export type $IngredientType_<T> = { streamCodec?: $StreamCodec<$RegistryFriendlyByteBuf, $ICustomIngredient>, codec?: $MapCodec<$ICustomIngredient>,  } | [streamCodec?: $StreamCodec<$RegistryFriendlyByteBuf, $ICustomIngredient>, codec?: $MapCodec<$ICustomIngredient>, ];
    /**
