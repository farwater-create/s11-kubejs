import { $Recipe, $RecipeManager, $RecipeType } from "@package/net/minecraft/world/item/crafting";
import { $CompoundTag, $CompoundTag_ } from "@package/net/minecraft/nbt";
import { $Either } from "@package/com/mojang/datafixers/util";
import { $EquipmentSlot_, $EntityType, $EquipmentSlot, $LivingEntity, $Mob, $MobCategory, $Entity } from "@package/net/minecraft/world/entity";
...
import { $BlockAndTintGetter, $Explosion, $LevelAccessor, $LevelReader, $ChunkPos, $BlockGetter, $SignalGetter, $Level } from "@package/net/minecraft/world/level";
...
declare module "@package/net/neoforged/neoforge/common/extensions" {
    ...
    export interface $IFluidExtension {
         ...
         */
        canConvertToSource(state: $FluidState, level: $Level, pos: $BlockPos_): boolean;
        /**
     ...
     */
    export type $IFluidExtension_ = (() => $FluidType);
    ...
    export interface $IDataComponentHolderExtension {
        ...
        addToTooltip<T extends $TooltipProvider>(type: $DataComponentType<T>, context: $Item$TooltipContext, adder: $Consumer_<$Component>, flag: $TooltipFlag): void;
    ...
    export interface $IFluidStateExtension {
         ...
         * Returns whether the fluid can create a source.
         */
        canConvertToSource(level: $Level, pos: $BlockPos_): boolean;
        /**
         * Returns whether the boat can be used on the fluid.
         */
    ...
    export interface $IIntrinsicHolderTagAppenderExtension<T> extends $ITagAppenderExtension<T> {
        remove(values: $TagKey_<T>): $IntrinsicHolderTagsProvider$IntrinsicTagAppender<T>;
        remove(arg0: $TagKey_<T>, ...arg1: $TagKey_<T>[]): $IntrinsicHolderTagsProvider$IntrinsicTagAppender<T>;
        ...
        remove(location: $ResourceLocation_): $IntrinsicHolderTagsProvider$IntrinsicTagAppender<T>;
        remove(arg0: $ResourceLocation_, ...arg1: $ResourceLocation_[]): $IntrinsicHolderTagsProvider$IntrinsicTagAppender<T>;
        ...
        replace(): $IntrinsicHolderTagsProvider$IntrinsicTagAppender<T>;
    ...
    export interface $IBlockStateExtension extends $IBlockStateExtensionMixin, $FabricBlockState {
         ...
         * Called when a user either starts or stops sleeping in the bed.
         */
        setBedOccupied(level: $Level, pos: $BlockPos_, sleeper: $LivingEntity, occupied: boolean): void;
        /**
         * Returns the direction of the block. Same values that
         ...
         * By default vanilla spawns particles only on the client and the server methods no-op.
         */
        addRunningEffects(level: $Level, pos: $BlockPos_, entity: $Entity): boolean;
        /**
         * Called when A user uses the creative pick block button on this block
         */
         ...
         * server sides!
         */
        onDestroyedByPushReaction(level: $Level, pos: $BlockPos_, pushDirection: $Direction_, fluid: $FluidState): void;
        /**
         * Determines the amount of enchanting power this block can provide to an enchanting table.
         */
         ...
         * This function is called on both the logical client and logical server.
         */
        onDestroyedByPlayer(level: $Level, pos: $BlockPos_, player: $Player, willHarvest: boolean, fluid: $FluidState): boolean;
        /**
         * Location sensitive version of getExplosionResistance
         */
        getExplosionResistance(level: $BlockGetter, pos: $BlockPos_, explosion: $Explosion): number;
         ...
         */
        getRespawnPosition(type: $EntityType<never>, level: $LevelReader, pos: $BlockPos_, orientation: number): ($ServerPlayer$RespawnPosAngle) | undefined;
        /**
         * Whether this block state has dynamic light emission which is not solely based on its underlying block or its
         * state properties and instead uses the `BlockPos`, the `AuxiliaryLightManager` or another external
         * data source to determine its light value in `#getLightEmission(BlockGetter, BlockPos)`
         ...
         * If the block is flammable, this is called when it gets lit on fire.
         */
        onCaughtFire(level: $Level, pos: $BlockPos_, face: $Direction_, igniter: $LivingEntity): void;
        /**
         * Returns whether the block can be hydrated by a fluid.
         * 
         * Hydration is an arbitrary word which depends on the block.
         ...
         * state, etc. when exploded, before it is removed.
         */
        onBlockExploded(level: $Level, pos: $BlockPos_, explosion: $Explosion): void;
        /**
         * Determines if a fluid adjacent to the block on the given side should not be rendered.
         */
