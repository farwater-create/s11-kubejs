...
import { $Entity, $EquipmentSlot_, $EntityType, $LivingEntity, $Mob, $SlotAccess } from "@package/net/minecraft/world/entity";
...
import { $DataComponentType, $DataComponentHolder_, $DataComponentHolder, $DataComponentMap_ } from "@package/net/minecraft/core/component";
...
import { $Item, $Tiers_, $Tier, $SpawnEggItem, $CreativeModeTab, $Item$Properties, $ItemStack_, $ItemStack } from "@package/net/minecraft/world/item";
import { $ChatDecorator, $Component_, $TextColor, $Component } from "@package/net/minecraft/network/chat";
import { $Biome$ClimateSettings, $BiomeSpecialEffects, $MobSpawnSettings, $Biome, $Biome$ClimateSettings_, $BiomeGenerationSettings } from "@package/net/minecraft/world/level/biome";
...
import { $LevelAccessor, $ChunkPos, $GameType, $LevelReader, $GameType_, $Level } from "@package/net/minecraft/world/level";
...
declare module "@package/net/neoforged/neoforge/common" {
    ...
    export class $CreativeModeTabRegistry {
         ...
         */
        static getName(tab: $CreativeModeTab): $ResourceLocation;
        /**
    ...
    export class $MonsterRoomHooks$MobEntry extends $Record implements $WeightedEntry {
        ...
        weight(): $Weight;
        getWeight(): $Weight;
        constructor(type: $EntityType<never>, weight: $Weight);
    }
    /**
     * Values that may be interpreted as {@link $MonsterRoomHooks$MobEntry}.
     */
    export type $MonsterRoomHooks$MobEntry_ = { weight?: $Weight, type?: $EntityType<never>,  } | [weight?: $Weight, type?: $EntityType<never>, ];
    export class $DataMapHooks {
        static getBlockUnwaxed(block: $Block): $Block;
        static getBlockWaxed(block: $Block): $Block;
        static getPreviousOxidizedStage(block: $Block): $Block;
        static getNextOxidizedStage(block: $Block): $Block;
    ...
    export class $CommonHooks {
         ...
         */
        static getVanillaFluidType(fluid: $Fluid): $FluidType;
        ...
        static onNoteChange(level: $Level, pos: $BlockPos_, state: $BlockState_, old: number, _new: number): number;
        static onFarmlandTrample(level: $Level, pos: $BlockPos_, state: $BlockState_, fallDistance: number, entity: $Entity): boolean;
        static fireCropGrowPost(level: $Level, pos: $BlockPos_, state: $BlockState_): void;
        /**
         * Checks if a crop can grow by firing `Pre`.
         */
        static canCropGrow(level: $Level, pos: $BlockPos_, state: $BlockState_, def: boolean): boolean;
        /**
         * @deprecated
        ...
        static onCheckCreativeTabs(...arg0: $CreativeModeTab[]): $Collection<$CreativeModeTab>;
        ...
        static getSerializer(id: number, vanilla: $CrudeIncrementalIntIdentityHashBiMap<$EntityDataSerializer<never>>): $EntityDataSerializer<never>;
        ...
        static getSerializerId(serializer: $EntityDataSerializer<never>, vanilla: $CrudeIncrementalIntIdentityHashBiMap<$EntityDataSerializer<never>>): number;
        /**
         ...
         */
        static fireBlockBreak(level: $Level, gameType: $GameType_, player: $ServerPlayer, pos: $BlockPos_, state: $BlockState_): $BlockEvent$BreakEvent;
        /**
         * @deprecated
        ...
        static loadMobEffect(nbt: $CompoundTag_, key: string, fallback: $MobEffect): $MobEffect;
        ...
        static saveMobEffect(nbt: $CompoundTag_, key: string, effect: $MobEffect): void;
        ...
        static onVanillaGameEvent(level: $Level, vanillaEvent: $Holder_<$GameEvent>, pos: $Vec3_, context: $GameEvent$Context_): boolean;
        /**
         * @deprecated
         * FOR INTERNAL USE ONLY, DO NOT CALL DIRECTLY
         */
        ...
        static isLivingOnLadder(state: $BlockState_, level: $Level, pos: $BlockPos_, entity: $LivingEntity): ($BlockPos) | undefined;
        /**
         * This is invoked in `)`
        ...
        static canEntityDestroy(level: $Level, pos: $BlockPos_, entity: $LivingEntity): boolean;
     ...
     */
    export type $CommonHooks$BiomeCallbackFunction_ = ((arg0: $Biome$ClimateSettings, arg1: $BiomeSpecialEffects, arg2: $BiomeGenerationSettings, arg3: $MobSpawnSettings) => $Biome);
    export class $FarmlandWaterManager {
        ...
        static addCustomTicket<T extends $SimpleTicket<$Vec3>>(arg0: $Level, arg1: T, arg2: $ChunkPos, ...arg3: $ChunkPos[]): T;
        /**
         ...
         */
        static addAABBTicket(level: $Level, aabb: $AABB_): $AABBTicket;
        constructor();
    }
    /**
    ...
    export class $DeferredSpawnEggItem extends $SpawnEggItem {
        static deferredOnlyById(type: $EntityType<never>): $SpawnEggItem;
    ...
    export interface $MutableDataComponentHolder extends $DataComponentHolder, $MutableDataComponentHolderFunctions {
        update<T>(arg0: $DataComponentType<T>, arg1: T, arg2: $UnaryOperator_<T>): T;
        ...
        update<T, U>(arg0: $DataComponentType<T>, arg1: T, arg2: U, arg3: $BiFunction_<T, U, T>): T;
