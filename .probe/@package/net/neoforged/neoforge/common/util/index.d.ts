...
import { $Decoder$Simple, $DataResult, $DynamicOps, $Codec, $Dynamic, $MapCodec, $Decoder, $Codec$ResultFunction, $Decoder$Boxed, $Lifecycle, $Encoder, $Decoder$Terminal, $Decoder_ } from "@package/com/mojang/serialization";
...
import { $Comparator, $Stack, $Map, $Map$Entry, $Set, $ListIterator, $Spliterator, $Iterator, $Properties, $UUID, $List, $Collection_, $List_ } from "@package/java/util";
...
declare module "@package/net/neoforged/neoforge/common/util" {
    ...
    export class $NeoForgeExtraCodecs {
        static xor<F, S>(mapCodec: $MapCodec<F>, alternative: $MapCodec<S>): $MapCodec<$Either<F, S>>;
        /**
        ...
        static withAlternative<T>(mapCodec: $MapCodec<T>, alternative: $MapCodec<T>): $MapCodec<T>;
        /**
         ...
         */
        static dispatchMapOrElse<A, E, B>(typeCodec: $Codec<A>, type: $Function_<E, A>, codec: $Function_<A, $MapCodec<E>>, fallbackCodec: $MapCodec<B>): $MapCodec<$Either<E, B>>;
        static mapWithAlternative<T>(mapCodec: $MapCodec<T>, alternative: $MapCodec<T>): $MapCodec<T>;
