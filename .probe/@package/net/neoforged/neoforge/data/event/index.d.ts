...
declare module "@package/net/neoforged/neoforge/data/event" {
     ...
     */
    export type $GatherDataEvent$ItemTagsProvider_ = ((arg0: $PackOutput, arg1: $CompletableFuture<$HolderLookup$Provider>, arg2: $CompletableFuture<$TagsProvider$TagLookup<$Block>>) => $TagsProvider<$Item>);
}
