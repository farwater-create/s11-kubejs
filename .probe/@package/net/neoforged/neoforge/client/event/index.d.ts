...
import { $RecipeHolder, $RecipeManager, $RecipeType } from "@package/net/minecraft/world/item/crafting";
...
import { $HumanoidArm_, $Entity, $EquipmentSlotGroup_, $HumanoidArm, $EntityType, $LivingEntity } from "@package/net/minecraft/world/entity";
import { $ParticleType, $ParticleOptions } from "@package/net/minecraft/core/particles";
...
import { $AbstractContainerMenu, $RecipeBookType_, $MenuType } from "@package/net/minecraft/world/inventory";
...
import { $Block, $SkullBlock$Type_ } from "@package/net/minecraft/world/level/block";
...
import { $ItemLike_, $ColorResolver_, $BlockAndTintGetter, $GameType, $GameType_, $Level } from "@package/net/minecraft/world/level";
...
declare module "@package/net/neoforged/neoforge/client/event" {
    ...
    export class $EntityRenderersEvent$RegisterRenderers extends $EntityRenderersEvent {
         ...
         */
        registerEntityRenderer<T extends $Entity>(entityType: $EntityType<T>, entityRendererProvider: $EntityRendererProvider_<T>): void;
        /**
         * Registers a block entity renderer for the given block entity type.
         */
        registerBlockEntityRenderer<T extends $BlockEntity>(blockEntityType: $BlockEntityType<T>, blockEntityRendererProvider: $BlockEntityRendererProvider_<T>): void;
        constructor();
    }
    /**
    ...
    export class $RegisterParticleProvidersEvent extends $Event implements $IModBusEvent {
         ...
         */
        registerSpriteSet<T extends $ParticleOptions>(type: $ParticleType<T>, registration: $ParticleEngine$SpriteParticleRegistration_<T>): void;
        /**
         ...
         * or a missing texture list error will occur when particle jsons load.
         */
        registerSprite<T extends $ParticleOptions>(type: $ParticleType<T>, sprite: $ParticleProvider$Sprite_<T>): void;
        /**
    ...
    export class $RegisterMenuScreensEvent extends $Event implements $IModBusEvent {
        register<M extends $AbstractContainerMenu, U extends $Screen>(menuType: $MenuType<M>, screenConstructor: $MenuScreens$ScreenConstructor_<M, U>): void;
        constructor(registeredScreens: $Map_<$MenuType<never>, $MenuScreens$ScreenConstructor_<never, never>>);
    }
    /**
    ...
    export class $RegisterSpriteSourceTypesEvent extends $Event implements $IModBusEvent {
         ...
         */
        register(id: $ResourceLocation_, codec: $MapCodec<$SpriteSource>): $SpriteSourceType;
        /**
    ...
    export class $RegisterEntitySpectatorShadersEvent extends $Event implements $IModBusEvent {
         ...
         */
        register(entityType: $EntityType<never>, shader: $ResourceLocation_): void;
        constructor(shaders: $Map_<$EntityType<never>, $ResourceLocation_>);
    }
    /**
    ...
    export class $EntityRenderersEvent$AddLayers extends $EntityRenderersEvent {
        ...
        getRenderer<T extends $Entity, R extends $EntityRenderer<T>>(arg0: $EntityType<T>): R;
        constructor(renderers: $Map_<$EntityType<never>, $EntityRenderer<never>>, playerRenderers: $Map_<$PlayerSkin$Model_, $EntityRenderer<$Player>>, context: $EntityRendererProvider$Context);
    ...
    export class $AddSectionGeometryEvent extends $Event {
        ...
        constructor(sectionOrigin: $BlockPos_, level: $Level);
        get level(): $Level;
    ...
    export class $RegisterItemDecorationsEvent extends $Event implements $IModBusEvent {
        ...
        constructor(decorators: $Map_<$Item, $List_<$IItemDecorator_>>);
    }
    /**
    ...
    export class $RegisterRecipeBookCategoriesEvent extends $Event implements $IModBusEvent {
         ...
         */
        registerRecipeCategoryFinder(type: $RecipeType<never>, lookup: $Function_<$RecipeHolder<never>, $RecipeBookCategories>): void;
        /**
        ...
        constructor(aggregateCategories: $Map_<$RecipeBookCategories_, $ImmutableList<$RecipeBookCategories_>>, typeCategories: $Map_<$RecipeBookType_, $ImmutableList<$RecipeBookCategories_>>, recipeCategoryLookups: $Map_<$RecipeType<never>, $Function_<$RecipeHolder<never>, $RecipeBookCategories>>);
    }
    /**
    ...
    export class $RegisterColorHandlersEvent$Block extends $RegisterColorHandlersEvent {
        register(arg0: $BlockColor_, ...arg1: $Block[]): void;
        /**
