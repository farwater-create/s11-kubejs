...
import { $FluidStack_, $FluidType } from "@package/net/neoforged/neoforge/fluids";
...
import { $BlockAndTintGetter, $LevelReader, $Level } from "@package/net/minecraft/world/level";
import { $Event } from "@package/net/neoforged/bus/api";
import { $Item, $ItemStack_, $ArmorMaterial$Layer } from "@package/net/minecraft/world/item";
...
declare module "@package/net/neoforged/neoforge/client/extensions/common" {
    ...
    export class $RegisterClientExtensionsEvent extends $Event implements $IModBusEvent {
        registerFluidType(arg0: $IClientFluidTypeExtensions, ...arg1: $FluidType[]): void;
        ...
        registerItem(arg0: $IClientItemExtensions, ...arg1: $Item[]): void;
    }
    /**
    ...
    export class $IClientFluidTypeExtensions {
        ...
        static of(type: $FluidType): $IClientFluidTypeExtensions;
        static of(fluid: $Fluid): $IClientFluidTypeExtensions;
    ...
    export class $IClientBlockExtensions {
        ...
        static of(block: $Block): $IClientBlockExtensions;
    ...
    export interface $IClientBlockExtensions {
         ...
         */
        addDestroyEffects(state: $BlockState_, Level: $Level, pos: $BlockPos_, manager: $ParticleEngine): boolean;
        /**
         ...
         */
        addHitEffects(state: $BlockState_, level: $Level, target: $HitResult, manager: $ParticleEngine): boolean;
        /**
         ...
         */
        playBreakSound(state: $BlockState_, level: $Level, pos: $BlockPos_): boolean;
        /**
    ...
    export class $IClientItemExtensions {
        ...
        static of(item: $Item): $IClientItemExtensions;
    ...
    export class $IClientMobEffectExtensions {
        ...
        static of(effect: $MobEffect): $IClientMobEffectExtensions;
