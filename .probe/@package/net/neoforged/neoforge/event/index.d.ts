...
import { $RecipeType } from "@package/net/minecraft/world/item/crafting";
import { $Either } from "@package/com/mojang/datafixers/util";
import { $CommandDispatcher, $ParseResults } from "@package/com/mojang/brigadier";
import { $LightningBolt, $MobCategory_, $EntityDimensions_, $Entity, $EquipmentSlotGroup_, $Pose_, $EntityType, $LivingEntity, $Mob, $SlotAccess, $SpawnGroupData, $MobSpawnType_ } from "@package/net/minecraft/world/entity";
...
import { $ServerLevelAccessor, $CustomSpawner_, $Explosion, $LevelAccessor, $ItemLike_, $ChunkPos, $BlockGetter, $CustomSpawner, $BaseSpawner, $Level, $SpawnData_ } from "@package/net/minecraft/world/level";
...
declare module "@package/net/neoforged/neoforge/event" {
    ...
    export class $VanillaGameEvent extends $Event implements $ICancellableEvent {
        ...
        setCanceled(arg0: boolean): void;
        isCanceled(): boolean;
        constructor(level: $Level, vanillaEvent: $Holder_<$GameEvent>, position: $Vec3_, context: $GameEvent$Context_);
        get cause(): $Entity;
    ...
    export class $PlayLevelSoundEvent extends $Event implements $ICancellableEvent {
        ...
        setCanceled(arg0: boolean): void;
        isCanceled(): boolean;
        constructor(level: $Level, sound: $Holder_<$SoundEvent>, source: $SoundSource_, volume: number, pitch: number);
        get level(): $Level;
    ...
    export class $EventHooks {
        ...
        static onExplosionDetonate(level: $Level, explosion: $Explosion, list: $List_<$Entity>, diameter: number): void;
        /**
         ...
         */
        static getExplosionKnockback(level: $Level, explosion: $Explosion, entity: $Entity, initialVelocity: $Vec3_): $Vec3;
        /**
        ...
        static onCreateWorldSpawn(level: $Level, settings: $ServerLevelData): boolean;
        /**
        ...
        static onEnchantmentLevelSet(level: $Level, pos: $BlockPos_, enchantRow: number, power: number, itemStack: $ItemStack_, enchantmentLevel: number): number;
         ...
         */
        static canEntityGrief(level: $Level, entity: $Entity): boolean;
         ...
         */
        static fireLevelTickPre(level: $Level, haveTime: $BooleanSupplier_): void;
        /**
         * Fires `Pre`. Called from `Minecraft#tick()` and `MinecraftServer#tickChildren(BooleanSupplier)` just before the try block for level tick is entered.
         */
        static fireLevelTickPost(level: $Level, haveTime: $BooleanSupplier_): void;
        /**
         ...
         */
        static canCreateFluidSource(level: $Level, pos: $BlockPos_, state: $BlockState_): boolean;
         ...
         */
        static onCreativeModeTabBuildContents(tab: $CreativeModeTab, tabKey: $ResourceKey_<$CreativeModeTab>, originalGenerator: $CreativeModeTab$DisplayItemsGenerator_, params: $CreativeModeTab$ItemDisplayParameters_, output: $CreativeModeTab$Output_): void;
        ...
        static onPlaySoundAtPosition(level: $Level, x: number, y: number, z: number, name: $Holder_<$SoundEvent>, category: $SoundSource_, volume: number, pitch: number): $PlayLevelSoundEvent$AtPosition;
        ...
        static onPistonMovePre(level: $Level, pos: $BlockPos_, direction: $Direction_, extending: boolean): boolean;
        static onPistonMovePost(level: $Level, pos: $BlockPos_, direction: $Direction_, extending: boolean): void;
        /**
         ...
         */
        static checkSpawnPlacements(entityType: $EntityType<never>, level: $ServerLevelAccessor, spawnType: $MobSpawnType_, pos: $BlockPos_, random: $RandomSource, defaultResult: boolean): boolean;
        ...
        static getItemBurnTime(itemStack: $ItemStack_, burnTime: number, recipeType: $RecipeType<never>): number;
        ...
        static canLivingConvert(entity: $LivingEntity, outcome: $EntityType<$LivingEntity>, timer: $Consumer_<number>): boolean;
        static onLivingConvert(entity: $LivingEntity, outcome: $LivingEntity): void;
        static onArrowLoose(stack: $ItemStack_, level: $Level, player: $Player, charge: number, hasAmmo: boolean): number;
        static onArrowNock(item: $ItemStack_, level: $Level, player: $Player, hand: $InteractionHand_, hasAmmo: boolean): $InteractionResultHolder<$ItemStack>;
        /**
         * Called when bone meal (or equivalent) is used on a block. Fires the `BonemealEvent` and returns the event.
         */
        static fireBonemealEvent(player: $Player, level: $Level, pos: $BlockPos_, state: $BlockState_, stack: $ItemStack_): $BonemealEvent;
        ...
        static onExplosionStart(level: $Level, explosion: $Explosion): boolean;
        static onNeighborNotify(arg0: $Level, arg1: $BlockPos_, arg2: $BlockState_, arg3: $EnumSet<$Direction_>, arg4: boolean): $BlockEvent$NeighborNotifyEvent;
        /**
    ...
    export class $BlockEntityTypeAddBlocksEvent extends $Event implements $IModBusEvent {
        modify(arg0: $ResourceKey_<$BlockEntityType<never>>, ...arg1: $Block[]): void;
        modify(arg0: $BlockEntityType<never>, ...arg1: $Block[]): void;
        modify(arg0: $BiPredicate_<$ResourceKey<$BlockEntityType<never>>, $BlockEntityType<never>>, ...arg1: $Block[]): void;
        constructor();
    }
    /**
    ...
    export class $BuildCreativeModeTabContentsEvent extends $Event implements $IModBusEvent, $CreativeModeTab$Output {
        ...
        constructor(tab: $CreativeModeTab, tabKey: $ResourceKey_<$CreativeModeTab>, parameters: $CreativeModeTab$ItemDisplayParameters_, parentEntries: $InsertableLinkedOpenCustomHashSet<$ItemStack_>, searchEntries: $InsertableLinkedOpenCustomHashSet<$ItemStack_>);
    ...
    export class $PlayLevelSoundEvent$AtPosition extends $PlayLevelSoundEvent {
         ...
         */
        getPosition(): $Vec3;
        constructor(level: $Level, position: $Vec3_, sound: $Holder_<$SoundEvent>, source: $SoundSource_, volume: number, pitch: number);
        get position(): $Vec3;
    }
}
