...
import { $CustomSpawner_, $Explosion, $LevelAccessor, $ChunkPos, $Level, $CustomSpawner } from "@package/net/minecraft/world/level";
...
declare module "@package/net/neoforged/neoforge/event/level" {
    ...
    export class $BlockEvent$NeighborNotifyEvent extends $BlockEvent implements $ICancellableEvent {
         ...
         */
        isCanceled(): boolean;
        constructor(level: $Level, pos: $BlockPos_, state: $BlockState_, notifiedSides: $EnumSet<$Direction_>, forceRedstoneUpdate: boolean);
    ...
    export class $BlockEvent$FarmlandTrampleEvent extends $BlockEvent implements $ICancellableEvent {
        ...
        setCanceled(arg0: boolean): void;
        isCanceled(): boolean;
        constructor(level: $Level, pos: $BlockPos_, state: $BlockState_, fallDistance: number, entity: $Entity);
        get entity(): $Entity;
    ...
    export class $NoteBlockEvent$Play extends $NoteBlockEvent implements $ICancellableEvent {
        ...
        setCanceled(arg0: boolean): void;
        isCanceled(): boolean;
        constructor(world: $Level, pos: $BlockPos_, state: $BlockState_, note: number, instrument: $NoteBlockInstrument_);
    }
    /**
    ...
    export class $PistonEvent$Post extends $PistonEvent {
        constructor(arg0: $Level, arg1: $BlockPos_, arg2: $Direction_, arg3: $PistonEvent$PistonMoveType_);
    }
    /**
    ...
    export class $BlockEvent$BreakEvent extends $BlockEvent implements $ICancellableEvent {
        ...
        setCanceled(canceled: boolean): void;
        isCanceled(): boolean;
        constructor(level: $Level, pos: $BlockPos_, state: $BlockState_, player: $Player);
        get player(): $Player;
    }
    /**
    ...
    export class $ExplosionKnockbackEvent extends $ExplosionEvent {
        ...
        constructor(level: $Level, explosion: $Explosion, entity: $Entity, knockbackVelocity: $Vec3_);
    ...
    export class $NoteBlockEvent$Change extends $NoteBlockEvent implements $ICancellableEvent {
        ...
        setCanceled(arg0: boolean): void;
        isCanceled(): boolean;
        constructor(world: $Level, pos: $BlockPos_, state: $BlockState_, oldNote: number, newNote: number);
    ...
    export class $ExplosionEvent$Detonate extends $ExplosionEvent {
         ...
         */
        getAffectedBlocks(): $List<$BlockPos>;
        constructor(level: $Level, explosion: $Explosion, entityList: $List_<$Entity>);
