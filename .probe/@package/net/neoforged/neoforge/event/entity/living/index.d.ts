...
import { $EquipmentSlot_, $EntityType, $SpawnGroupData, $Entity, $EquipmentSlot, $LivingEntity, $AgeableMob, $Mob, $MobSpawnType_, $MobSpawnType } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/neoforged/neoforge/event/entity/living" {
    ...
    export class $MobSpawnEvent$SpawnPlacementCheck extends $Event {
         ...
         * Internal.
         */
        constructor(entityType: $EntityType<never>, level: $ServerLevelAccessor, spawnType: $MobSpawnType_, pos: $BlockPos_, random: $RandomSource, defaultResult: boolean);
        get level(): $ServerLevelAccessor;
    ...
    export class $LivingConversionEvent$Pre extends $LivingConversionEvent implements $ICancellableEvent {
        ...
        setCanceled(arg0: boolean): void;
        isCanceled(): boolean;
        constructor(entity: $LivingEntity, outcome: $EntityType<$LivingEntity>, timer: $Consumer_<number>);
