...
import { $GameType, $GameType_, $Level, $BlockGetter } from "@package/net/minecraft/world/level";
...
declare module "@package/net/neoforged/neoforge/event/entity/player" {
    ...
    export class $ArrowNockEvent extends $PlayerEvent implements $ICancellableEvent {
        ...
        setCanceled(arg0: boolean): void;
        isCanceled(): boolean;
        constructor(player: $Player, item: $ItemStack_, hand: $InteractionHand_, level: $Level, hasAmmo: boolean);
        get level(): $Level;
    ...
    export class $ArrowLooseEvent extends $PlayerEvent implements $ICancellableEvent {
        ...
        setCanceled(arg0: boolean): void;
        isCanceled(): boolean;
        constructor(player: $Player, bow: $ItemStack_, level: $Level, charge: number, hasAmmo: boolean);
        get level(): $Level;
        get bow(): $ItemStack;
    }
    /**
    ...
    export class $BonemealEvent extends $Event implements $ICancellableEvent {
         ...
         */
        isCanceled(): boolean;
        constructor(player: $Player, level: $Level, pos: $BlockPos_, state: $BlockState_, stack: $ItemStack_);
        get state(): $BlockState;
        get stack(): $ItemStack;
        get level(): $Level;
        get player(): $Player;
