...
import { $EntityDimensions, $LightningBolt, $LivingEntity, $Pose, $Pose_, $EntityDimensions_, $SpawnPlacementType_, $EntityType, $Entity, $SpawnPlacements$SpawnPredicate_, $SpawnPlacementType, $SpawnPlacements$SpawnPredicate } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/neoforged/neoforge/event/entity" {
    ...
    export class $EntityJoinLevelEvent extends $EntityEvent implements $ICancellableEvent {
        ...
        constructor(entity: $Entity, level: $Level, loadedFromDisk: boolean);
        get level(): $Level;
    }
    /**
    ...
    export class $EntityAttributeModificationEvent extends $Event implements $IModBusEvent {
        add(entityType: $EntityType<$LivingEntity>, attribute: $Holder_<$Attribute>): void;
        add(entityType: $EntityType<$LivingEntity>, attribute: $Holder_<$Attribute>, value: number): void;
        has(entityType: $EntityType<$LivingEntity>, attribute: $Holder_<$Attribute>): boolean;
        getTypes(): $List<$EntityType<$LivingEntity>>;
        constructor(mapIn: $Map_<$EntityType<$LivingEntity>, $AttributeSupplier$Builder>);
    ...
    export class $EntityMountEvent extends $EntityEvent implements $ICancellableEvent {
        ...
        setCanceled(arg0: boolean): void;
        isCanceled(): boolean;
        constructor(entityMounting: $Entity, entityBeingMounted: $Entity, level: $Level, isMounting: boolean);
        get level(): $Level;
    ...
    export class $EntityAttributeCreationEvent extends $Event implements $IModBusEvent {
        put(entity: $EntityType<$LivingEntity>, map: $AttributeSupplier): void;
        constructor(map: $Map_<$EntityType<$LivingEntity>, $AttributeSupplier>);
    }
    /**
    ...
    export class $RegisterSpawnPlacementsEvent extends $Event implements $IModBusEvent {
        register<T extends $Entity>(arg0: $EntityType<T>, arg1: $SpawnPlacementType_, arg2: $Heightmap$Types_, arg3: $SpawnPlacements$SpawnPredicate_<T>, arg4: $RegisterSpawnPlacementsEvent$Operation_): void;
        register<T extends $Entity>(arg0: $EntityType<T>, arg1: $SpawnPlacements$SpawnPredicate_<T>, arg2: $RegisterSpawnPlacementsEvent$Operation_): void;
        /**
         * Register an optional spawn placement `predicate` for a given `entityType`
         */
        register<T extends $Entity>(entityType: $EntityType<T>, predicate: $SpawnPlacements$SpawnPredicate_<T>): void;
        constructor(map: $Map_<$EntityType<never>, $RegisterSpawnPlacementsEvent$MergedSpawnPredicate<never>>);
    }
    /**
    ...
    export class $EntityMobGriefingEvent extends $EntityEvent {
        ...
        constructor(level: $Level, entity: $Entity);
