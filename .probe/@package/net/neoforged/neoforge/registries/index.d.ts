...
declare module "@package/net/neoforged/neoforge/registries" {
    ...
    export class $DeferredRegister$Items extends $DeferredRegister<$Item> {
         ...
         */
        register<I extends $Item>(name: string, func: $Function_<$ResourceLocation, I>): $DeferredItem<I>;
        /**
         * Adds a new item to the list of entries to be registered and returns a `DeferredItem` that will be populated with the created item automatically.
         */
        register<I extends $Item>(name: string, sup: $Supplier_<I>): $DeferredItem<I>;
        /**
         * Adds a new item to the list of entries to be registered and returns a `DeferredItem` that will be populated with the created item automatically.
         */
    ...
    export class $DeferredRegister$Blocks extends $DeferredRegister<$Block> {
         ...
         */
        register<B extends $Block>(name: string, func: $Function_<$ResourceLocation, B>): $DeferredBlock<B>;
        /**
         * Adds a new block to the list of entries to be registered and returns a `DeferredHolder` that will be populated with the created block automatically.
         */
        register<B extends $Block>(name: string, sup: $Supplier_<B>): $DeferredBlock<B>;
        /**
    ...
    export class $RegisterEvent extends $Event implements $IModBusEvent, $RegisterEventAccessor {
        ...
        static yumi$init$yumi_mc_core_$md$707fe4$0(arg0: $ResourceKey_<any>, arg1: $Registry<any>): $RegisterEvent;
    ...
    export class $DataPackRegistriesHooks implements $DataPackRegistriesHooksAccessor {
        ...
        static set_DATA_PACK_REGISTRIES_VIEW$connector_$md$707fe4$1(arg0: $List_<any>): void;
        ...
        static set_DATA_PACK_REGISTRIES$connector_$md$707fe4$0(arg0: $List_<any>): void;
        static get dataPackRegistries(): $List<$RegistryDataLoader$RegistryData<never>>;
        static set _DATA_PACK_REGISTRIES_VIEW$connector_$md$707fe4$1(value: $List_<any>);
        ...
        static set _DATA_PACK_REGISTRIES$connector_$md$707fe4$0(value: $List_<any>);
    }
    ...
    export class $NeoForgeRegistriesSetup implements $NeoForgeRegistriesSetupAccessor {
        ...
        static invokeModifyRegistries$connector_$md$707fe4$0(arg0: $ModifyRegistriesEvent): void;
        constructor();
    ...
    export class $RegistryManager implements $RegistryManagerAccessor {
        static invokeTrackModdedRegistry$fabric_registry_sync_v0_$md$707fe4$0(arg0: $ResourceLocation_): void;
    ...
    export class $NewRegistryEvent extends $Event implements $IModBusEvent, $NewRegistryEventNeoForgeAccessor {
        ...
        static callInit$puzzleslib_$md$707fe4$0(): $NewRegistryEvent;
