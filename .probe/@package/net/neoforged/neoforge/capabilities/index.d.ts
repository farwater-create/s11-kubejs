import { $ChunkPos, $Level, $ItemLike_ } from "@package/net/minecraft/world/level";
...
declare module "@package/net/neoforged/neoforge/capabilities" {
    ...
    export interface $IBlockCapabilityProvider<T, C> {
        getCapability(arg0: $Level, arg1: $BlockPos_, arg2: $BlockState_, arg3: $BlockEntity, arg4: C): T;
    }
    /**
    ...
    export class $RegisterCapabilitiesEvent extends $Event implements $IModBusEvent, $ITrackingCapEvent {
         ...
         */
        registerEntity<T, C, E extends $Entity>(capability: $EntityCapability<T, C>, entityType: $EntityType<E>, provider: $ICapabilityProvider_<E, C, T>): void;
        /**
         ...
         */
        registerBlockEntity<T, C, BE extends $BlockEntity>(capability: $BlockCapability<T, C>, blockEntityType: $BlockEntityType<BE>, provider: $ICapabilityProvider_<BE, C, T>): void;
         ...
         */
        isItemRegistered(capability: $ItemCapability<never, never>, item: $Item): boolean;
        /**
         * Return `true` if a provider is registered for the given block and capability.
         */
        isBlockRegistered(capability: $BlockCapability<never, never>, block: $Block): boolean;
        /**
         * Return `true` if a provider is registered for the given entity type and capability.
         */
        isEntityRegistered(capability: $EntityCapability<never, never>, entityType: $EntityType<never>): boolean;
        registerBlock<T, C>(arg0: $BlockCapability<T, C>, arg1: $IBlockCapabilityProvider_<T, C>, ...arg2: $Block[]): void;
