...
import { $DataComponentType, $DataComponentPredicate, $DataComponentMap_ } from "@package/net/minecraft/core/component";
...
declare module "@package/net/neoforged/neoforge/fluids/crafting" {
     ...
     */
    export type $FluidIngredientType_<T> = { streamCodec?: $StreamCodec<$RegistryFriendlyByteBuf, $FluidIngredient_>, codec?: $MapCodec<$FluidIngredient_>,  } | [streamCodec?: $StreamCodec<$RegistryFriendlyByteBuf, $FluidIngredient_>, codec?: $MapCodec<$FluidIngredient_>, ];
    /**
    ...
    export class $DataComponentFluidIngredient extends $FluidIngredient {
        ...
        static of<T>(arg0: boolean, arg1: $Supplier_<$DataComponentType<T>>, arg2: T, ...arg3: $Fluid[]): $FluidIngredient;
        /**
        ...
        static of(arg0: boolean, arg1: $DataComponentPredicate, ...arg2: $Fluid[]): $FluidIngredient;
        static of(arg0: boolean, arg1: $DataComponentMap_, ...arg2: $Fluid[]): $FluidIngredient;
        /**
        ...
        static of<T>(arg0: boolean, arg1: $DataComponentType<T>, arg2: T, ...arg3: $Fluid[]): $FluidIngredient;
        isStrict(): boolean;
    ...
    export class $FluidIngredient implements $Predicate<$FluidStack>, $FluidIngredientKJS, $FluidIngredientStacksInvoker {
        ...
        static of(...arg0: $Fluid[]): $FluidIngredient;
        static single(fluids: $FluidStack_): $FluidIngredient;
        static single(fluids: $Fluid): $FluidIngredient;
