...
import { $MobCategory_, $EntityType$EntityFactory_, $SpawnPlacementType_, $EntityType, $Mob, $LivingEntity, $EntityType$Builder, $SpawnPlacements$SpawnPredicate_ } from "@package/net/minecraft/world/entity";
