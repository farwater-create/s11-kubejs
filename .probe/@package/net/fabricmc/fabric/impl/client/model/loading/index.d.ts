...
declare module "@package/net/fabricmc/fabric/impl/client/model/loading" {
    export class $ModelLoadingEventDispatcher {
        ...
        loadBlockStateModels(arg0: $ResourceLocation_, arg1: $StateDefinition<$Block, $BlockState_>): boolean;
    ...
    export interface $BlockStatesLoaderHooks$LoadingOverride {
        loadBlockStates(arg0: $ResourceLocation_, arg1: $StateDefinition<$Block, $BlockState_>): boolean;
    }
    /**
