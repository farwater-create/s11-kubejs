...
import { $AttachmentType, $IAttachmentSerializer } from "@package/net/neoforged/neoforge/attachment";
...
declare module "@package/net/fabricmc/fabric/mixin/attachment" {
     ...
     */
    export type $AttachmentHolderAccessor_ = (() => $Map_<$AttachmentType<never>, $Object>);
