...
declare module "@package/net/fabricmc/fabric/mixin/content/registry" {
    export class $AxeItemAccessor {
        ...
        static setStrippedBlocks(arg0: $Map_<$Block, $Block>): void;
    }
    ...
    export class $VillagerEntityAccessor {
        static fabric_setItemFoodValues(arg0: $Map_<$Item, number>): void;
        static fabric_setGatherableItems(arg0: $Set_<$Item>): void;
    ...
    export class $FarmerWorkTaskAccessor {
        static fabric_setCompostables(arg0: $List_<$Item>): void;
