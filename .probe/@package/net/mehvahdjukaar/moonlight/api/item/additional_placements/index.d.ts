...
declare module "@package/net/mehvahdjukaar/moonlight/api/item/additional_placements" {
    ...
    export class $BlockPlacerItem extends $BlockItem {
        ...
        mimicGetPlacementState(arg0: $BlockPlaceContext, arg1: $Block): $BlockState;
        mimicPlace(arg0: $BlockPlaceContext, arg1: $Block, arg2: $SoundType_): $InteractionResult;
        mimicUseOn(arg0: $UseOnContext, arg1: $Block, arg2: $FoodProperties_): $InteractionResult;
