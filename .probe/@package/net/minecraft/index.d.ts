...
declare module "@package/net/minecraft" {
    ...
    export class $SystemReport implements $SystemReportAccessor {
        ...
        static getOPERATING_SYSTEM$create_$md$707fe4$0(): string;
        static getJAVA_VERSION$create_$md$707fe4$1(): string;
        getEntries(): $Map<string, string>;
        static BYTES_PER_MEBIBYTE: number;
        constructor();
        static get OPERATING_SYSTEM$create_$md$707fe4$0(): string;
        static get JAVA_VERSION$create_$md$707fe4$1(): string;
    ...
    export class $BlockUtil {
        ...
        static getTopConnectedBlock(getter: $BlockGetter, pos: $BlockPos_, baseBlock: $Block, direction: $Direction_, endBlock: $Block): ($BlockPos) | undefined;
        /**
    ...
    export class $CrashReport {
        ...
        handler$edi000$yumi_mc_core$yumi$onCrashReportCreate(crashReportBuilder: $StringBuilder, ci: $CallbackInfo): void;
        /**
         * Gets the stack trace of the Throwable that caused this crash report, or if that fails, the cause `.toString()`.
         */
        getDetails(): string;
