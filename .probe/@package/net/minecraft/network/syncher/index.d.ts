...
declare module "@package/net/minecraft/network/syncher" {
    ...
    export class $EntityDataSerializers {
         ...
         * @deprecated
         */
        static registerSerializer(serializer: $EntityDataSerializer<never>): void;
        static getSerializedId(serializer: $EntityDataSerializer<never>): number;
     ...
     */
    export type $SynchedEntityData$DataValue_<T> = { serializer?: $EntityDataSerializer<any>, id?: number, value?: any,  } | [serializer?: $EntityDataSerializer<any>, id?: number, value?: any, ];
    /**
    ...
    export class $EntityDataAccessor<T> extends $Record {
        id(): number;
        serializer(): $EntityDataSerializer<T>;
        constructor(id: number, serializer: $EntityDataSerializer<T>);
    }
    /**
     * Values that may be interpreted as {@link $EntityDataAccessor}.
     */
    export type $EntityDataAccessor_<T> = { id?: number, serializer?: $EntityDataSerializer<any>,  } | [id?: number, serializer?: $EntityDataSerializer<any>, ];
    /**
    ...
    export class $SynchedEntityData {
         ...
         */
        static defineId<T>(clazz: $Class<$SyncedDataHolder>, serializer: $EntityDataSerializer<T>): $EntityDataAccessor<T>;
        /**
         * Gets all data entries which have changed since the last check and clears their dirty flag.
         */
