...
import { $RelativeMovement_, $EntityType, $Entity } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/minecraft/server/commands" {
    ...
    export class $SummonCommand {
        static register(dispatcher: $CommandDispatcher<$CommandSourceStack>, context: $CommandBuildContext): void;
        static createEntity(source: $CommandSourceStack, type: $Holder$Reference<$EntityType<never>>, pos: $Vec3_, tag: $CompoundTag_, randomizeProperties: boolean): $Entity;
        constructor();
    }
    ...
    export class $PlaceCommand {
        ...
        static placeStructure(source: $CommandSourceStack, feature: $Holder$Reference<$Structure>, pos: $BlockPos_): number;
    ...
    export class $GameRuleCommand implements $GameRuleCommandAccessor {
        ...
        static invokeQueryRule$fabric_game_rule_api_v1_$md$707fe4$0(source: $CommandSourceStack, gameRule: $GameRules$Key<any>): number;
