...
import { $EntityDimensions, $Entity$RemovalReason, $LivingEntity, $Pose, $PortalProcessor, $WalkAnimationState, $EntityType, $MobSpawnType_ } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/minecraft/world/entity/monster/hoglin" {
    ...
    export class $Hoglin extends $Animal implements $Enemy, $HoglinBase {
        ...
        static checkHoglinSpawnRules(hoglin: $EntityType<$Hoglin>, level: $LevelAccessor, spawnType: $MobSpawnType_, pos: $BlockPos_, random: $RandomSource): boolean;
        /**
         * Entity won't drop items or experience points if this returns false
         */
        ...
        age: number;
        constructor(entityType: $EntityType<$Hoglin>, level: $Level);
        get adult(): boolean;
