...
import { $Pose, $PortalProcessor, $EntityType, $AnimationState, $EntityDimensions, $Entity$RemovalReason, $LivingEntity, $WalkAnimationState } from "@package/net/minecraft/world/entity";
...
import { $Behavior, $Behavior$Status, $MoveToTargetSink } from "@package/net/minecraft/world/entity/ai/behavior";
...
declare module "@package/net/minecraft/world/entity/monster/breeze" {
    ...
    export class $Breeze extends $Monster {
        ...
        handler$dld000$immersiveengineering$deflection(arg0: $Projectile, arg1: $CallbackInfoReturnable<any>): void;
