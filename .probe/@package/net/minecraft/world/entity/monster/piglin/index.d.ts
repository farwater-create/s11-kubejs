...
import { $Pose, $PortalProcessor, $EntityType, $EntityDimensions, $Entity$RemovalReason, $LivingEntity, $WalkAnimationState, $MobSpawnType_ } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/minecraft/world/entity/monster/piglin" {
    ...
    export class $PiglinAi {
        ...
        static isZombified(entityType: $EntityType<never>): boolean;
    ...
    export class $AbstractPiglin extends $Monster {
        ...
        removeStingerTime: number;
        static BASE_SAFE_FALL_DISTANCE: number;
        constructor(entityType: $EntityType<$AbstractPiglin>, level: $Level);
        get adult(): boolean;
    ...
    export class $Piglin extends $AbstractPiglin implements $CrossbowAttackMob, $InventoryCarrier {
        localvar$zdi000$openpartiesandclaims$onWantsToPickupPre(stack: $ItemStack_): $ItemStack;
        modify$zdi000$openpartiesandclaims$onWantsToPickupPost(arg0: $Piglin): $Piglin;
        /**
         * Dismounts this entity from the entity it is riding.
         */
        ...
        static checkPiglinSpawnRules(piglin: $EntityType<$Piglin>, level: $LevelAccessor, spawnType: $MobSpawnType_, pos: $BlockPos_, random: $RandomSource): boolean;
        /**
