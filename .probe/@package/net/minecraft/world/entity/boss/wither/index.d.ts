...
import { $EntityDimensions, $PowerableMob, $Entity$RemovalReason, $LivingEntity, $Pose, $PortalProcessor, $WalkAnimationState, $EntityType } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/minecraft/world/entity/boss/wither" {
    ...
    export class $WitherBoss extends $Monster implements $PowerableMob, $RangedAttackMob {
        ...
        constructor(entityType: $EntityType<$WitherBoss>, level: $Level);
        get powered(): boolean;
    }
}
