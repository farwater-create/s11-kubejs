...
import { $EntityDimensions, $Entity$RemovalReason, $Pose, $PortalProcessor, $WalkAnimationState, $EntityType, $Mob, $Entity } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/minecraft/world/entity/boss/enderdragon" {
    export class $EndCrystal extends $Entity {
        ...
        constructor(entityType: $EntityType<$EndCrystal>, level: $Level);
    ...
    export class $EnderDragon extends $Mob implements $Enemy {
        ...
        static BASE_SAFE_FALL_DISTANCE: number;
        constructor(entityType: $EntityType<$EnderDragon>, level: $Level);
