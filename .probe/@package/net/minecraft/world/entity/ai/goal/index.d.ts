...
declare module "@package/net/minecraft/world/entity/ai/goal" {
    ...
    export class $CatSitOnBlockGoal extends $MoveToBlockGoal {
        handler$eea000$lootr$LootrPlayersUsing(arg0: $LevelReader, arg1: $BlockPos_, arg2: $CallbackInfoReturnable<any>): void;
        handler$bgc000$supplementaries$supp$shouldMoveToCarpet(arg0: $LevelReader, arg1: $BlockPos_, arg2: $CallbackInfoReturnable<any>): void;
        redirect$eea000$lootr$LootrIsIn(arg0: $BlockState_, arg1: $Block): boolean;
        speedModifier: number;
        mob: $PathfinderMob;
        tryTicks: number;
        blockPos: $BlockPos;
    ...
    export class $RemoveBlockGoal extends $MoveToBlockGoal implements $LithiumMoveToBlockGoal {
        ...
        playBreakSound(level: $Level, pos: $BlockPos_): void;
        redirect$cii000$lithium$redirectFindNearestBlock(arg0: $RemoveBlockGoal): boolean;
        speedModifier: number;
        mob: $PathfinderMob;
        tryTicks: number;
        blockPos: $BlockPos;
        verticalSearchStart: number;
        constructor(blockToRemove: $Block, removerMob: $PathfinderMob, speedModifier: number, arg3: number);
    }
    ...
    export class $UseItemGoal<T extends $Mob> extends $Goal {
        constructor(mob: T, item: $ItemStack_, finishUsingSound: $SoundEvent | null, canUseSelector: $Predicate_<T>);
    }
