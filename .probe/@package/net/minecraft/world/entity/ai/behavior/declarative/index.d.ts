...
declare module "@package/net/minecraft/world/entity/ai/behavior/declarative" {
    export class $MemoryCondition$Registered<Value> extends $Record implements $MemoryCondition<$OptionalBox$Mu, Value> {
        ...
        constructor(arg0: $MemoryModuleType<Value>);
    }
    /**
     * Values that may be interpreted as {@link $MemoryCondition$Registered}.
     */
    export type $MemoryCondition$Registered_<Value> = { memory?: $MemoryModuleType<any>,  } | [memory?: $MemoryModuleType<any>, ];
    ...
    export class $BehaviorBuilder$Instance<E extends $LivingEntity> implements $Applicative<$BehaviorBuilder$Mu<E>, $BehaviorBuilder$Instance$Mu<E>> {
        ...
        present<Value>(memoryType: $MemoryModuleType<Value>): $BehaviorBuilder<E, $MemoryAccessor<$IdF$Mu, Value>>;
        registered<Value>(memoryType: $MemoryModuleType<Value>): $BehaviorBuilder<E, $MemoryAccessor<$OptionalBox$Mu, Value>>;
        ...
        absent<Value>(memoryType: $MemoryModuleType<Value>): $BehaviorBuilder<E, $MemoryAccessor<$Const$Mu<$Unit>, Value>>;
     ...
     */
    export type $MemoryCondition$Present_<Value> = { memory?: $MemoryModuleType<any>,  } | [memory?: $MemoryModuleType<any>, ];
     ...
     */
    export type $MemoryCondition$Absent_<Value> = { memory?: $MemoryModuleType<any>,  } | [memory?: $MemoryModuleType<any>, ];
    ...
    export class $MemoryAccessor<F extends $K1, Value> {
        ...
        constructor(brain: $Brain<never>, memoryType: $MemoryModuleType<Value>, value: $App<F, Value>);
