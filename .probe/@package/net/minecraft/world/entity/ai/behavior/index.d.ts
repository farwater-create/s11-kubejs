...
import { $MobCategory_, $EntityType, $Entity, $PathfinderMob, $LivingEntity, $AgeableMob, $Mob } from "@package/net/minecraft/world/entity";
...
import { $MemoryModuleType, $MemoryStatus_, $MemoryStatus } from "@package/net/minecraft/world/entity/ai/memory";
...
declare module "@package/net/minecraft/world/entity/ai/behavior" {
    ...
    export class $CopyMemoryWithExpiry {
        static create<E extends $LivingEntity, T>(canCopyMemory: $Predicate_<E>, sourceMemory: $MemoryModuleType<T>, targetMemory: $MemoryModuleType<T>, durationOfCopy: $UniformInt): $BehaviorControl<E>;
        constructor();
    }
    ...
    export class $WorkAtComposter extends $WorkAtPoi implements $FarmerWorkTaskAccessor {
        static fabric_getCompostable$fabric_content_registries_v0_$md$707fe4$1(): $List<any>;
        static fabric_setCompostables$fabric_content_registries_v0_$md$707fe4$0(arg0: $List_<any>): void;
        static DEFAULT_DURATION: number;
        entryCondition: $Map<$MemoryModuleType<never>, $MemoryStatus>;
        endTimestamp: number;
        status: $Behavior$Status;
    ...
    export class $ValidateNearbyPoi {
        static create(poiValidator: $Predicate_<$Holder<$PoiType>>, poiPosMemory: $MemoryModuleType<$GlobalPos_>): $BehaviorControl<$LivingEntity>;
        constructor();
    }
    ...
    export class $SetWalkTargetAwayFrom {
        static pos(walkTargetAwayFromMemory: $MemoryModuleType<$BlockPos_>, speedModifier: number, desiredDistance: number, hasTarget: boolean): $BehaviorControl<$PathfinderMob>;
        static entity(walkTargetAwayFromMemory: $MemoryModuleType<$Entity>, speedModifier: number, desiredDistance: number, hasTarget: boolean): $OneShot<$PathfinderMob>;
        constructor();
    }
    ...
    export class $TryLaySpawnOnWaterNearLand {
        static create(spawnBlock: $Block): $BehaviorControl<$LivingEntity>;
        constructor();
    }
    ...
    export class $SetEntityLookTargetSometimes {
        static create(entityType: $EntityType<never>, maxDist: number, interval: $UniformInt): $BehaviorControl<$LivingEntity>;
    ...
    export class $Behavior<E extends $LivingEntity> implements $BehaviorControl<E> {
        ...
        endTimestamp: number;
        status: $Behavior$Status;
        constructor(entryCondition: $Map_<$MemoryModuleType<never>, $MemoryStatus_>, minDuration: number, maxDuration: number);
        constructor(entryCondition: $Map_<$MemoryModuleType<never>, $MemoryStatus_>, duration: number);
        constructor(entryCondition: $Map_<$MemoryModuleType<never>, $MemoryStatus_>);
    }
    export class $Mount {
    ...
    export class $EraseMemoryIf {
        static create<E extends $LivingEntity>(shouldEraseMemory: $Predicate_<E>, erasingMemory: $MemoryModuleType<never>): $BehaviorControl<E>;
        constructor();
    }
    ...
    export class $CelebrateVillagersSurvivedRaid extends $Behavior<$Villager> {
        ...
        canStillUse(level: $ServerLevel, entity: $Villager, gameTime: number): boolean;
        checkExtraStartConditions(level: $ServerLevel, owner: $Villager): boolean;
        handler$bgd000$supplementaries$tick(arg0: $ServerLevel, arg1: $Villager, arg2: number, arg3: $CallbackInfo): void;
        static DEFAULT_DURATION: number;
        entryCondition: $Map<$MemoryModuleType<never>, $MemoryStatus>;
        endTimestamp: number;
        status: $Behavior$Status;
    ...
    export class $GoToTargetLocation {
        static create<E extends $Mob>(locationMemory: $MemoryModuleType<$BlockPos_>, closeEnoughDist: number, speedModifier: number): $OneShot<E>;
        constructor();
    }
    export class $StrollToPoiList {
        static create(poiListMemory: $MemoryModuleType<$List_<$GlobalPos_>>, speedModifier: number, closeEnoughDist: number, maxDistFromPoi: number, mustBeCloseToMemory: $MemoryModuleType<$GlobalPos_>): $BehaviorControl<$Villager>;
        constructor();
    }
    ...
    export class $AcquirePoi {
        static create(acquirablePois: $Predicate_<$Holder<$PoiType>>, existingAbsentMemory: $MemoryModuleType<$GlobalPos_>, acquiringMemory: $MemoryModuleType<$GlobalPos_>, onlyIfAdult: boolean, entityEventId: (number) | undefined): $BehaviorControl<$PathfinderMob>;
        static create(acquirablePois: $Predicate_<$Holder<$PoiType>>, acquiringMemory: $MemoryModuleType<$GlobalPos_>, onlyIfAdult: boolean, entityEventId: (number) | undefined): $BehaviorControl<$PathfinderMob>;
    ...
    export class $StrollAroundPoi {
        static create(poiPosMemory: $MemoryModuleType<$GlobalPos_>, speedModifier: number, maxDistFromPoi: number): $OneShot<$PathfinderMob>;
        constructor();
    }
    ...
    export class $BecomePassiveIfMemoryPresent {
        static create(pacifyingMemory: $MemoryModuleType<never>, pacifyDuration: number): $BehaviorControl<$LivingEntity>;
        constructor();
    }
    export class $GateBehavior<E extends $LivingEntity> implements $BehaviorControl<E> {
        ...
        constructor(entryCondition: $Map_<$MemoryModuleType<never>, $MemoryStatus_>, exitErasedMemories: $Set_<$MemoryModuleType<never>>, orderPolicy: $GateBehavior$OrderPolicy_, runningPolicy: $GateBehavior$RunningPolicy_, durations: $List_<$Pair<$BehaviorControl<E>, number>>);
        get status(): $Behavior$Status;
    }
    export class $InteractWith {
        static of<E extends $LivingEntity, T extends $LivingEntity>(type: $EntityType<T>, interactionRange: number, selfFilter: $Predicate_<E>, targetFilter: $Predicate_<T>, memory: $MemoryModuleType<T>, speedModifier: number, maxDist: number): $BehaviorControl<E>;
        static of<T extends $LivingEntity>(type: $EntityType<T>, interactionRange: number, interactMemory: $MemoryModuleType<T>, speedModifier: number, maxDist: number): $BehaviorControl<$LivingEntity>;
        constructor();
    }
    ...
    export class $BehaviorUtils {
        ...
        static getLivingEntityFromUUIDMemory(livingEntity: $LivingEntity, targetMemory: $MemoryModuleType<$UUID_>): ($LivingEntity) | undefined;
        ...
        static targetIsValid(brains: $Brain<never>, memorymodule: $MemoryModuleType<$LivingEntity>, entityType: $EntityType<never>): boolean;
    }
    ...
    export class $GiveGiftToHero extends $Behavior<$Villager> implements $HeroGiftsTaskAccess, $GiveGiftsToHeroTaskAccessor {
        ...
        stop(level: $ServerLevel, entity: $Villager, gameTime: number): void;
        tick(level: $ServerLevel, entity: $Villager, gameTime: number): void;
        static getGifts$immersiveengineering_$md$707fe4$0(): $Map<any, any>;
        canStillUse(level: $ServerLevel, entity: $Villager, gameTime: number): boolean;
        static fabric_getGifts$fabric_content_registries_v0_$md$707fe4$0(): $Map<any, any>;
        checkExtraStartConditions(level: $ServerLevel, owner: $Villager): boolean;
        static DEFAULT_DURATION: number;
        entryCondition: $Map<$MemoryModuleType<never>, $MemoryStatus>;
        endTimestamp: number;
        ...
        static get gifts$immersiveengineering_$md$707fe4$0(): $Map<any, any>;
    }
    ...
    export class $StrollToPoi {
        static create(poiPosMemory: $MemoryModuleType<$GlobalPos_>, speedModifier: number, closeEnoughDist: number, maxDistFromPoi: number): $BehaviorControl<$PathfinderMob>;
        constructor();
    }
    ...
    export class $SetEntityLookTarget {
        ...
        static create(entityType: $EntityType<never>, maxDist: number): $OneShot<$LivingEntity>;
    ...
    export class $SetLookAndInteract {
        static create(entityType: $EntityType<never>, maxDist: number): $BehaviorControl<$LivingEntity>;
        constructor();
    }
    ...
    export class $RunOne<E extends $LivingEntity> extends $GateBehavior<E> {
        ...
        constructor(entryCondition: $Map_<$MemoryModuleType<never>, $MemoryStatus_>, durations: $List_<$Pair<$BehaviorControl<E>, number>>);
    }
    export class $SetWalkTargetFromBlockMemory {
        static create(blockTargetMemory: $MemoryModuleType<$GlobalPos_>, speedModifier: number, closeEnoughDist: number, tooFarDistance: number, tooLongUnreachableDuration: number): $OneShot<$Villager>;
        constructor();
    }
