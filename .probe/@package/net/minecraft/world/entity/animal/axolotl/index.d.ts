...
import { $Pose, $PortalProcessor, $VariantHolder, $LerpingModel, $EntityType, $AgeableMob$AgeableMobGroupData, $EntityDimensions, $Entity$RemovalReason, $LivingEntity, $WalkAnimationState, $Mob, $MobSpawnType_ } from "@package/net/minecraft/world/entity";
...
import { $ServerLevelAccessor, $Level } from "@package/net/minecraft/world/level";
...
declare module "@package/net/minecraft/world/entity/animal/axolotl" {
    ...
    export class $Axolotl extends $Animal implements $LerpingModel, $VariantHolder<$Axolotl$Variant>, $Bucketable {
         ...
         */
        fromBucket(): boolean;
        static checkAxolotlSpawnRules(axolotl: $EntityType<$LivingEntity>, level: $ServerLevelAccessor, spawnType: $MobSpawnType_, pos: $BlockPos_, random: $RandomSource): boolean;
        ...
        age: number;
        constructor(entityType: $EntityType<$Axolotl>, level: $Level);
