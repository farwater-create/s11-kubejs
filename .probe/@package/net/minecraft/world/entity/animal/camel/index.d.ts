...
import { $Pose, $PortalProcessor, $PlayerRideableJumping, $EntityType, $AnimationState, $EntityDimensions, $Entity$RemovalReason, $Saddleable, $AgeableMob, $WalkAnimationState, $Mob } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/minecraft/world/entity/animal/camel" {
    ...
    export class $Camel extends $AbstractHorse implements $PlayerRideableJumping, $Saddleable {
        ...
        constructor(entityType: $EntityType<$Camel>, level: $Level);
