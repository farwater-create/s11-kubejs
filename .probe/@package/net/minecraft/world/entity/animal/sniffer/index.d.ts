...
import { $Pose, $PortalProcessor, $EntityType, $AnimationState, $EntityDimensions, $Entity$RemovalReason, $WalkAnimationState } from "@package/net/minecraft/world/entity";
