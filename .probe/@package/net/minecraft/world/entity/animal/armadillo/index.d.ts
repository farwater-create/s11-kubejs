...
import { $Pose, $PortalProcessor, $EntityType, $AnimationState, $EntityDimensions, $Entity$RemovalReason, $LivingEntity, $WalkAnimationState, $MobSpawnType_ } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/minecraft/world/entity/animal/armadillo" {
    ...
    export class $Armadillo extends $Animal {
        ...
        static checkArmadilloSpawnRules(entityType: $EntityType<$Armadillo>, level: $LevelAccessor, spawnType: $MobSpawnType_, pos: $BlockPos_, random: $RandomSource): boolean;
        /**
