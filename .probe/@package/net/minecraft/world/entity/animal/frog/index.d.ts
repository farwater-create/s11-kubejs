...
import { $Pose, $PortalProcessor, $VariantHolder, $EntityType, $Entity, $AnimationState, $EntityDimensions, $Entity$RemovalReason, $LivingEntity, $WalkAnimationState, $Mob, $MobSpawnType_ } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/minecraft/world/entity/animal/frog" {
    ...
    export class $Frog extends $Animal implements $VariantHolder<$Holder<$FrogVariant>> {
        ...
        static checkFrogSpawnRules(animal: $EntityType<$Animal>, level: $LevelAccessor, spawnType: $MobSpawnType_, pos: $BlockPos_, random: $RandomSource): boolean;
