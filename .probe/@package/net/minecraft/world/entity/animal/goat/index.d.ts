...
import { $EntityDimensions, $Entity$RemovalReason, $Pose, $PortalProcessor, $AgeableMob, $WalkAnimationState, $EntityType, $MobSpawnType_ } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/minecraft/world/entity/animal/goat" {
    ...
    export class $Goat extends $Animal {
        ...
        static checkGoatSpawnRules(goat: $EntityType<$Animal>, level: $LevelAccessor, spawnType: $MobSpawnType_, pos: $BlockPos_, random: $RandomSource): boolean;
        /**
         * Called every tick so the entity can update its state as required. For example, zombies and skeletons use this to react to sunlight and start to burn.
         */
        removeHorns(): void;
        ...
        age: number;
        constructor(entityType: $EntityType<$Goat>, level: $Level);
