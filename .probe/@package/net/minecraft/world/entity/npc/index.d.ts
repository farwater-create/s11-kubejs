...
import { $VariantHolder, $EntityType, $EntityDimensions, $Entity$RemovalReason, $AgeableMob, $WalkAnimationState, $Mob, $Pose, $PortalProcessor, $Entity, $ReputationEventHandler } from "@package/net/minecraft/world/entity";
...
import { $ItemLike_, $Level, $CustomSpawner } from "@package/net/minecraft/world/level";
...
declare module "@package/net/minecraft/world/entity/npc" {
    ...
    export class $VillagerProfession extends $Record {
        ...
        constructor(name: string, heldJobSite: $Predicate_<$Holder<$PoiType>>, acquirableJobSite: $Predicate_<$Holder<$PoiType>>, requestedItems: $ImmutableSet<$Item>, secondaryPoi: $ImmutableSet<$Block>, workSound: $SoundEvent | null);
    }
    /**
     * Values that may be interpreted as {@link $VillagerProfession}.
     */
    export type $VillagerProfession_ = { acquirableJobSite?: $Predicate_<$Holder<$PoiType>>, secondaryPoi?: $ImmutableSet<$Block>, heldJobSite?: $Predicate_<$Holder<$PoiType>>, name?: string, requestedItems?: $ImmutableSet<$Item>, workSound?: $SoundEvent,  } | [acquirableJobSite?: $Predicate_<$Holder<$PoiType>>, secondaryPoi?: $ImmutableSet<$Block>, heldJobSite?: $Predicate_<$Holder<$PoiType>>, name?: string, requestedItems?: $ImmutableSet<$Item>, workSound?: $SoundEvent, ];
    export class $AbstractVillager extends $AgeableMob implements $InventoryCarrier, $Npc, $Merchant {
        ...
        age: number;
        constructor(entityType: $EntityType<$AbstractVillager>, level: $Level);
        get trading(): boolean;
    ...
    export class $WanderingTrader extends $AbstractVillager {
        ...
        handler$bij000$supplementaries$supp$addOpenDoor(arg0: $CallbackInfo): void;
        static MAX_WEARING_ARMOR_CHANCE: number;
        lastHurtByPlayerTime: number;
        static PRESERVE_ITEM_DROP_CHANCE_THRESHOLD: number;
        autoSpinAttackItemStack: $ItemStack;
        ...
        static BASE_SAFE_FALL_DISTANCE: number;
        age: number;
        constructor(entityType: $EntityType<$WanderingTrader>, level: $Level);
    }
    export class $VillagerTrades$ItemsForEmeralds implements $VillagerTrades$ItemListing {
        ...
        constructor(item: $Item, emeraldCost: number, numberOfItems: number, maxUses: number, villagerXp: number, priceMultiplier: number);
        constructor(item: $Item, emeraldCost: number, numberOfItems: number, maxUses: number, villagerXp: number, priceMultiplier: number, enchantmentProvider: $ResourceKey_<$EnchantmentProvider>);
        ...
        constructor(block: $Block, emeraldCost: number, numberOfItems: number, maxUses: number, villagerXp: number);
        constructor(item: $Item, emeraldCost: number, numberOfItems: number, villagerXp: number);
        constructor(item: $Item, emeraldCost: number, numberOfItems: number, maxUses: number, villagerXp: number);
    ...
    export class $VillagerTrades$TreasureMapForEmeralds implements $VillagerTrades$ItemListing {
        getOffer(trader: $Entity, random: $RandomSource): $MerchantOffer;
        handler$bfd000$supplementaries$turnToQuill(arg0: $Entity, arg1: $RandomSource, arg2: $CallbackInfoReturnable<any>): void;
    ...
    export class $Villager extends $AbstractVillager implements $ReputationEventHandler, $VillagerDataHolder, $VillagerEntityAccessor {
        static fabric_getGatherableItems$fabric_content_registries_v0_$md$707fe4$2(): $Set<any>;
        /**
         * Called to update the entity's position/logic.
         */
        restock(): void;
        releasePoi(moduleType: $MemoryModuleType<$GlobalPos_>): void;
        ...
        static fabric_setItemFoodValues$fabric_content_registries_v0_$md$707fe4$0(equipments: $Map_<any, any>): void;
        ...
        handler$iil000$moonlight$reg(arg0: $Brain<any>, arg1: $CallbackInfo): void;
        /**
         * Used by `TradeWithVillager` to check if the villager can give some items from an inventory to another villager.
         */
        assignProfessionWhenSpawned(): boolean;
        static fabric_setGatherableItems$fabric_content_registries_v0_$md$707fe4$1(arg0: $Set_<any>): void;
        ...
        constructor(entityType: $EntityType<$Villager>, level: $Level, villagerType: $VillagerType);
    ...
    export class $VillagerTrades$DyedArmorForEmeralds implements $VillagerTrades$ItemListing {
        ...
        constructor(item: $Item, value: number, maxUses: number, villagerXp: number);
    }
    export class $VillagerTrades$TypeSpecificTrade extends $Record implements $VillagerTrades$ItemListing {
        ...
        static oneTradeInBiomes(listing: $VillagerTrades$ItemListing_, ...types: $VillagerType[]): $VillagerTrades$TypeSpecificTrade;
        constructor(trades: $Map_<$VillagerType, $VillagerTrades$ItemListing_>);
    }
    /**
     * Values that may be interpreted as {@link $VillagerTrades$TypeSpecificTrade}.
     */
    export type $VillagerTrades$TypeSpecificTrade_ = { trades?: $Map_<$VillagerType, $VillagerTrades$ItemListing_>,  } | [trades?: $Map_<$VillagerType, $VillagerTrades$ItemListing_>, ];
    ...
    export class $VillagerTrades$EnchantedItemForEmeralds implements $VillagerTrades$ItemListing {
        getOffer(trader: $Entity, random: $RandomSource): $MerchantOffer;
        constructor(item: $Item, baseEmeraldCost: number, maxUses: number, villagerXp: number);
        constructor(item: $Item, baseEmeraldCost: number, maxUses: number, villagerXp: number, priceMultiplier: number);
    }
    ...
    export class $VillagerData {
        ...
        setType(type: $VillagerType): $VillagerData;
        getLevel(): number;
        ...
        constructor(type: $VillagerType, profession: $VillagerProfession_, level: number);
    }
    export class $VillagerTrades$ItemsAndEmeraldsToItems implements $VillagerTrades$ItemListing {
        ...
        constructor(fromItem: $ItemLike_, fromItemCount: number, emeraldCost: number, toItem: $Item, toItemCount: number, maxUses: number, villagerXp: number, priceMultiplier: number);
    }
    export class $VillagerTrades$EmeraldsForVillagerTypeItem implements $VillagerTrades$ItemListing {
        getOffer(trader: $Entity, random: $RandomSource): $MerchantOffer;
        constructor(cost: number, maxUses: number, villagerXp: number, trades: $Map_<$VillagerType, $Item>);
    }
    ...
    export class $VillagerTrades$TippedArrowForItemsAndEmeralds implements $VillagerTrades$ItemListing {
        getOffer(trader: $Entity, random: $RandomSource): $MerchantOffer;
        constructor(fromItem: $Item, fromCount: number, toItem: $Item, toCount: number, emeraldCost: number, maxUses: number, villagerXp: number);
    }
    ...
    export class $WanderingTraderSpawner implements $CustomSpawner {
        tick(level: $ServerLevel, spawnHostiles: boolean, spawnPassives: boolean): number;
        handler$bia000$supplementaries$supp$spawnRedMerchant(arg0: $ServerLevel, arg1: $CallbackInfoReturnable<any>): void;
        handler$bia000$supplementaries$supp$tickRedMerchant(arg0: $ServerLevel, arg1: boolean, arg2: boolean, arg3: $CallbackInfoReturnable<any>): void;
