...
import { $AnimationState, $EntityDimensions, $Entity$RemovalReason, $Pose, $PortalProcessor, $WalkAnimationState, $EntityType, $Mob, $MobSpawnType_ } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/minecraft/world/entity/ambient" {
    export class $Bat extends $AmbientCreature {
        static checkBatSpawnRules(bat: $EntityType<$Bat>, level: $LevelAccessor, spawnType: $MobSpawnType_, pos: $BlockPos_, random: $RandomSource): boolean;
        ...
        constructor(entityType: $EntityType<$Bat>, level: $Level);
    }
    export class $AmbientCreature extends $Mob {
        ...
        removeStingerTime: number;
        static BASE_SAFE_FALL_DISTANCE: number;
        constructor(arg0: $EntityType<$AmbientCreature>, arg1: $Level);
    }
}
