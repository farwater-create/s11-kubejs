...
declare module "@package/net/minecraft/world/level/levelgen/structure/pools/alias" {
    ...
    export class $PoolAliasBindings {
        static bootstrap(registry: $Registry<$MapCodec<$PoolAliasBinding>>): $MapCodec<$PoolAliasBinding>;
        static registerTargetsAsPools(context: $BootstrapContext<$StructureTemplatePool>, pool: $Holder_<$StructureTemplatePool>, poolAliasBindings: $List_<$PoolAliasBinding>): void;
        constructor();
    }
