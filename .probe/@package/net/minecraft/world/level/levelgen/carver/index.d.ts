...
declare module "@package/net/minecraft/world/level/levelgen/carver" {
     ...
     */
    export type $ConfiguredWorldCarver_<WC> = { worldCarver?: $WorldCarver<$CarverConfiguration>, config?: $CarverConfiguration,  } | [worldCarver?: $WorldCarver<$CarverConfiguration>, config?: $CarverConfiguration, ];
}
