...
declare module "@package/net/minecraft/world/level/levelgen/blockpredicates" {
    ...
    export class $BlockPredicate {
        ...
        static matchesFluids(offset: $Vec3i, ...fluids: $Fluid[]): $BlockPredicate;
        static matchesFluids(offset: $Vec3i, blocks: $List_<$Fluid>): $BlockPredicate;
        static matchesFluids(...fluids: $Fluid[]): $BlockPredicate;
        ...
        static matchesBlocks(offset: $Vec3i, ...blocks: $Block[]): $BlockPredicate;
        static matchesBlocks(predicates: $List_<$Block>): $BlockPredicate;
        static matchesBlocks(...blocks: $Block[]): $BlockPredicate;
        static matchesBlocks(offset: $Vec3i, blocks: $List_<$Block>): $BlockPredicate;
     ...
     */
    export type $BlockPredicateType_<P> = (() => $MapCodec<P>);
