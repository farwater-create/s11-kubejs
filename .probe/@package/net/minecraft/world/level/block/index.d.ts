...
import { $EquipmentSlot, $LivingEntity, $Mob, $Entity, $EntityType } from "@package/net/minecraft/world/entity";
...
import { $IceBlockAccessor } from "@package/net/antopfr/advancedweather/mixin";
...
import { $IceInvoker } from "@package/com/ordana/immersive_weathering/mixins/accessors";
...
import { $TooltipFlag, $Item$TooltipContext, $DyeColor, $DyeColor_, $ItemStack_, $ItemStack, $Item, $Equipable } from "@package/net/minecraft/world/item";
...
import { $ItemLike_, $LevelReader, $CollisionGetter, $LevelHeightAccessor, $Level, $Explosion, $LevelAccessor, $BlockGetter, $SignalGetter, $BlockAndTintGetter, $ItemLike } from "@package/net/minecraft/world/level";
...
import { $FlowingFluid, $Fluid, $MapColor, $FluidState, $PushReaction } from "@package/net/minecraft/world/level/material";
...
import { $ChestBlockEntity, $SignBlockEntity, $BeehiveBlockEntity$BeeReleaseStatus_, $SkullBlockEntity, $BlockEntityType, $AbstractFurnaceBlockEntity, $BlockEntityTicker_, $BlockEntity, $LidBlockEntity_, $EnderChestBlockEntity, $BlockEntityTicker, $DispenserBlockEntity } from "@package/net/minecraft/world/level/block/entity";
...
declare module "@package/net/minecraft/world/level/block" {
    ...
    export class $BambooStalkBlock extends $Block implements $BonemealableBlock {
        ...
        isBonemealSuccess(level: $Level, random: $RandomSource, pos: $BlockPos_, state: $BlockState_): boolean;
        handler$ijk001$immersive_weathering$iw$canSurviveOnIwSoil(state: $BlockState_, level: $LevelReader, pos: $BlockPos_, cir: $CallbackInfoReturnable<any>): void;
        growBamboo(state: $BlockState_, level: $Level, pos: $BlockPos_, random: $RandomSource, age: number): void;
        handler$jkk000$axiom$getStateForPlacementReturn(blockPlaceContext: $BlockPlaceContext, cir: $CallbackInfoReturnable<any>): void;
    ...
    export class $DispenserBlock extends $BaseEntityBlock implements $IDispenserAccessor, $DispenserBlockAccessor, $DispenserBlockAccessor$1 {
        handler$fjd000$farmersdelight$onCuttingBoardDispenseFromInject(arg0: $ServerLevel, arg1: $BlockState_, arg2: $BlockPos_, arg3: $CallbackInfo, arg4: $DispenserBlockEntity, arg5: $BlockSource_, arg6: number, arg7: $ItemStack_): void;
        ...
        getDispenseMethod(level: $Level, item: $ItemStack_): $DispenseItemBehavior;
        localvar$zbn000$openpartiesandclaims$onDispenseFrom(arg0: $DispenseItemBehavior_, arg1: $ServerLevel, arg2: $BlockState_, arg3: $BlockPos_): $DispenseItemBehavior;
        static getDispenserRegistry$moonlight_$md$707fe4$0(): $Map<any, any>;
        ...
        create$callGetDispenseMethod(level: $Level, item: $ItemStack_): $DispenseItemBehavior;
        invokeGetDispenseMethod(level: $Level, item: $ItemStack_): $DispenseItemBehavior;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        ...
        hasCollision: boolean;
        constructor(properties: $BlockBehaviour$Properties);
        static get dispenserRegistry$moonlight_$md$707fe4$0(): $Map<any, any>;
    }
    ...
    export class $NetherrackBlock extends $Block implements $BonemealableBlock {
        ...
        isBonemealSuccess(arg0: $Level, arg1: $RandomSource, arg2: $BlockPos_, arg3: $BlockState_): boolean;
    ...
    export class $KelpBlock extends $GrowingPlantHeadBlock implements $LiquidBlockContainer {
        ...
        canPlaceLiquid(player: $Player | null, level: $BlockGetter, pos: $BlockPos_, state: $BlockState_, fluid: $Fluid): boolean;
        growthDirection: $Direction;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static MAX_AGE: number;
    ...
    export class $SeagrassBlock extends $BushBlock implements $BonemealableBlock, $LiquidBlockContainer, $IShearable {
        ...
        getType(): $BonemealableBlock$Type;
        getParticlePos(arg0: $BlockPos_): $BlockPos;
        spawnShearedDrop(arg0: $Level, arg1: $BlockPos_, arg2: $ItemStack_): void;
        isShearable(arg0: $Player, arg1: $ItemStack_, arg2: $Level, arg3: $BlockPos_): boolean;
        onSheared(arg0: $Player, arg1: $ItemStack_, arg2: $Level, arg3: $BlockPos_): $List<$ItemStack>;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $BubbleColumnBlock extends $Block implements $BucketPickup {
        ...
        wrapOperation$ijn000$immersive_weathering$canSurvive(instance: $BlockState_, block: $Block, original: $Operation_<any>): boolean;
    ...
    export class $WoolCarpetBlock extends $CarpetBlock implements $Equipable {
        ...
        getColor(): $DyeColor;
        swapWithEquipmentSlot(item: $Item, level: $Level, player: $Player, hand: $InteractionHand_): $InteractionResultHolder<$ItemStack>;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $ConcretePowderBlock extends $FallingBlock implements $ConcretePowderBlockAccess, $ConcretePowderBlockAccessor {
        ...
        static UPDATE_CLIENTS: number;
        hasCollision: boolean;
        constructor(concrete: $Block, properties: $BlockBehaviour$Properties);
    }
    ...
    export class $LeavesBlock extends $Block implements $SimpleWaterloggedBlock, $IShearable, $BonemealableBlock {
        performBonemeal(level: $ServerLevel, random: $RandomSource, pos: $BlockPos_, state: $BlockState_): void;
        isBonemealSuccess(level: $Level, random: $RandomSource, pos: $BlockPos_, state: $BlockState_): boolean;
        decaying(state: $BlockState_): boolean;
        handler$ikf000$immersive_weathering$onRemoved(blockState: $BlockState_, serverLevel: $ServerLevel, blockPos: $BlockPos_, random: $RandomSource, ci: $CallbackInfo): void;
        isValidBonemealTarget(level: $LevelReader, pos: $BlockPos_, state: $BlockState_): boolean;
         ...
         */
        spawnShearedDrop(level: $Level, pos: $BlockPos_, stack: $ItemStack_): void;
        /**
    ...
    export class $CocoaBlock extends $HorizontalDirectionalBlock implements $BonemealableBlock {
        performBonemeal(level: $ServerLevel, random: $RandomSource, pos: $BlockPos_, state: $BlockState_): void;
        isBonemealSuccess(level: $Level, random: $RandomSource, pos: $BlockPos_, state: $BlockState_): boolean;
        handler$jkp001$axiom$getStateForPlacementReturn(blockPlaceContext: $BlockPlaceContext, cir: $CallbackInfoReturnable<any>): void;
        isValidBonemealTarget(level: $LevelReader, pos: $BlockPos_, state: $BlockState_): boolean;
        getType(): $BonemealableBlock$Type;
        getParticlePos(pos: $BlockPos_): $BlockPos;
    ...
    export class $CoralBlock extends $Block {
        ...
        static UPDATE_CLIENTS: number;
        hasCollision: boolean;
        constructor(deadBlock: $Block, properties: $BlockBehaviour$Properties);
    }
    ...
    export class $TntBlock extends $Block implements $BlockWithSubLevelCollisionCallback {
         ...
         * @deprecated
         */
        static explode(level: $Level, pos: $BlockPos_): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
     ...
     */
    export type $PointedDripstoneBlock$FluidInfo_ = { fluid?: $Fluid, sourceState?: $BlockState_, pos?: $BlockPos_,  } | [fluid?: $Fluid, sourceState?: $BlockState_, pos?: $BlockPos_, ];
    ...
    export class $LeverBlock extends $FaceAttachedHorizontalDirectionalBlock {
        pull(state: $BlockState_, level: $Level, pos: $BlockPos_, player: $Player | null): void;
    ...
    export class $EnchantingTableBlock extends $BaseEntityBlock {
        static isValidBookShelf(level: $Level, enchantingTablePos: $BlockPos_, bookshelfPos: $BlockPos_): boolean;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
    ...
    export class $RailState {
        ...
        constructor(level: $Level, pos: $BlockPos_, state: $BlockState_);
    ...
    export class $FenceBlock extends $CrossCollisionBlock {
        ...
        handler$fjj000$farmersdelight$denyConnectionToRopeFenceGate(arg0: $BlockState_, arg1: boolean, arg2: $Direction_, arg3: $CallbackInfoReturnable<any>): void;
        handler$fjj000$farmersdelight$denyConnectionToRopeFence(arg0: $BlockState_, arg1: $CallbackInfoReturnable<any>): void;
        modifyReturnValue$gfl000$amendments$cauldronConnect(arg0: boolean, arg1: $BlockState_, arg2: boolean, arg3: $Direction_): boolean;
        handler$fgm000$create_connected$hasProperties(arg0: $CallbackInfoReturnable<any>): void;
        explosionResistance: number;
        shapeByIndex: $VoxelShape[];
        static WEST: $BooleanProperty;
        static UPDATE_SHAPE_ORDER: $Direction[];
    ...
    export class $BaseCoralWallFanBlock extends $BaseCoralFanBlock {
        redirect$jkl000$axiom$getStateForPlacementCanSurvive(state: $BlockState_, level: $LevelReader, pos: $BlockPos_): boolean;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $DoubleBlockCombiner {
        static combineWithNeigbour<S extends $BlockEntity>(blockEntityType: $BlockEntityType<S>, doubleBlockTypeGetter: $Function_<$BlockState, $DoubleBlockCombiner$BlockType>, directionGetter: $Function_<$BlockState, $Direction>, directionProperty: $DirectionProperty, state: $BlockState_, level: $LevelAccessor, pos: $BlockPos_, blockedChestTest: $BiPredicate_<$LevelAccessor, $BlockPos>): $DoubleBlockCombiner$NeighborCombineResult<S>;
        constructor();
    }
    export class $SkullBlock extends $AbstractSkullBlock implements $SimpleWaterloggedBlock {
        modifyReturnValue$ggf000$amendments$addPlacementWaterlogging(arg0: $BlockState_, arg1: $BlockPlaceContext): $BlockState;
        pickupBlock(player: $Player, level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_): $ItemStack;
        placeLiquid(level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_, fluidState: $FluidState): boolean;
        handler$ggf000$amendments$addWaterlogging(arg0: $StateDefinition$Builder<any, any>, arg1: $CallbackInfo): void;
        canPlaceLiquid(player: $Player | null, level: $BlockGetter, pos: $BlockPos_, state: $BlockState_, fluid: $Fluid): boolean;
        getPickupSound(): ($SoundEvent) | undefined;
        /**
         * State sensitive variant of `BucketPickup#getPickupSound()`.
    ...
    export class $AbstractChestBlock<E extends $BlockEntity> extends $BaseEntityBlock {
        combine(state: $BlockState_, level: $Level, pos: $BlockPos_, override: boolean): $DoubleBlockCombiner$NeighborCombineResult<$ChestBlockEntity>;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $DoublePlantBlock extends $BushBlock {
        handler$jla000$axiom$setPlacedBy(level: $Level, blockPos: $BlockPos_, blockState: $BlockState_, livingEntity: $LivingEntity, itemStack: $ItemStack_, ci: $CallbackInfo): void;
        static placeAt(level: $LevelAccessor, state: $BlockState_, pos: $BlockPos_, flags: number): void;
        handler$jla002$axiom$getStateForPlacementReturn(blockPlaceContext: $BlockPlaceContext, cir: $CallbackInfoReturnable<any>): void;
        static preventDropFromBottomPart(level: $Level, pos: $BlockPos_, state: $BlockState_, player: $Player): void;
    ...
    export class $LanternBlock extends $Block implements $SimpleWaterloggedBlock {
        modifyReturnValue$jld001$axiom$getStateForPlacementReturn(blockState: $BlockState_, blockPlaceContext: $BlockPlaceContext): $BlockState;
    ...
    export class $ComparatorBlock extends $DiodeBlock implements $EntityBlock {
        ...
        handler$bge000$supplementaries$supp$updateSideRelayers(arg0: $Level, arg1: $BlockPos_, arg2: $BlockState_, arg3: $CallbackInfo): void;
        getListener<T extends $BlockEntity>(level: $ServerLevel, blockEntity: T): $GameEventListener;
        getTicker<T extends $BlockEntity>(level: $Level, state: $BlockState_, blockEntityType: $BlockEntityType<T>): $BlockEntityTicker<T>;
        explosionResistance: number;
    ...
    export class $DoorBlock extends $Block {
        ...
        setOpen(entity: $Entity | null, level: $Level, state: $BlockState_, pos: $BlockPos_, open: boolean): void;
        static isWoodenDoor(level: $Level, pos: $BlockPos_): boolean;
        static isWoodenDoor(state: $BlockState_): boolean;
        playSound(source: $Entity | null, level: $Level, pos: $BlockPos_, isOpening: boolean): void;
        static SOUTH_AABB: $VoxelShape;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
    ...
    export class $BaseEntityBlock extends $Block implements $EntityBlock {
        static createTickerHelper<E extends $BlockEntity, A extends $BlockEntity>(serverType: $BlockEntityType<A>, clientType: $BlockEntityType<E>, ticker: $BlockEntityTicker_<E>): $BlockEntityTicker<A>;
        getListener<T extends $BlockEntity>(level: $ServerLevel, blockEntity: T): $GameEventListener;
        getTicker<T extends $BlockEntity>(level: $Level, state: $BlockState_, blockEntityType: $BlockEntityType<T>): $BlockEntityTicker<T>;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
    ...
    export class $SpreadingSnowyDirtBlock extends $SnowyDirtBlock {
        ...
        handler$fob000$vinery$onTick(state: $BlockState_, world: $ServerLevel, pos: $BlockPos_, random: $RandomSource, ci: $CallbackInfo, defaultState: $BlockState_, j: number, spreadPos: $BlockPos_): void;
        static canBeGrass(state: $BlockState_, levelReader: $LevelReader, pos: $BlockPos_): boolean;
        wrapOperation$ike000$immersive_weathering$mayPlaceOn(instance: $BlockState_, block: $Block, operation: $Operation_<any>, newSoil: $LocalRef<any>): boolean;
        wrapOperation$ike000$immersive_weathering$mayPlaceOn(instance: $ServerLevel, pos: $BlockPos_, state: $BlockState_, operation: $Operation_<any>, newSoil: $LocalRef<any>): boolean;
        static SNOWY: $BooleanProperty;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
    ...
    export class $BellBlock extends $BaseEntityBlock implements $BlockWithSubLevelCollisionCallback {
        sable$getCallback(): $BlockSubLevelCollisionCallback;
        attemptToRing(level: $Level, pos: $BlockPos_, direction: $Direction_ | null): boolean;
        attemptToRing(entity: $Entity | null, level: $Level, pos: $BlockPos_, direction: $Direction_ | null): boolean;
        onHit(level: $Level, state: $BlockState_, result: $BlockHitResult, player: $Player | null, canRingBell: boolean): boolean;
        handler$gfe000$amendments$updateShape(arg0: $BlockState_, arg1: $Direction_, arg2: $BlockState_, arg3: $LevelAccessor, arg4: $BlockPos_, arg5: $BlockPos_, arg6: $CallbackInfoReturnable<any>): void;
        handler$gfe000$amendments$updateObservers(arg0: $Entity, arg1: $Level, arg2: $BlockPos_, arg3: $Direction_, arg4: $CallbackInfoReturnable<any>, arg5: $BlockEntity): void;
    ...
    export class $ComposterBlock extends $Block implements $WorldlyContainerHolder {
        ...
        static extractProduce(entity: $Entity, state: $BlockState_, level: $Level, pos: $BlockPos_): $BlockState;
        static handleFill(level: $Level, pos: $BlockPos_, success: boolean): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
    ...
    export class $LayeredCauldronBlock extends $AbstractCauldronBlock {
        static lowerFillLevel(state: $BlockState_, level: $Level, pos: $BlockPos_): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
    ...
    export class $CandleCakeBlock extends $AbstractCandleBlock {
        ...
        static UPDATE_CLIENTS: number;
        hasCollision: boolean;
        constructor(candleBlock: $Block, properties: $BlockBehaviour$Properties);
    }
    ...
    export class $LightningRodBlock extends $RodBlock implements $SimpleWaterloggedBlock {
        onLightningStrike(state: $BlockState_, level: $Level, pos: $BlockPos_): void;
        pickupBlock(player: $Player | null, level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_): $ItemStack;
        placeLiquid(level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_, fluidState: $FluidState): boolean;
        canPlaceLiquid(player: $Player | null, level: $BlockGetter, pos: $BlockPos_, state: $BlockState_, fluid: $Fluid): boolean;
        getPickupSound(): ($SoundEvent) | undefined;
    ...
    export class $BaseFireBlock extends $Block {
        ...
        static canBePlacedAt(level: $Level, pos: $BlockPos_, direction: $Direction_): boolean;
    ...
    export class $BaseRailBlock extends $Block implements $SimpleWaterloggedBlock, $IBaseRailBlockExtension {
        ...
        updateState(state: $BlockState_, level: $Level, pos: $BlockPos_, movedByPiston: boolean): $BlockState;
        updateState(state: $BlockState_, level: $Level, pos: $BlockPos_, neighborBlock: $Block): void;
        /**
         * @deprecated
         */
        getShapeProperty(): $Property<$RailShape>;
        static isRail(state: $BlockState_): boolean;
        static isRail(level: $Level, pos: $BlockPos_): boolean;
        updateDir(level: $Level, pos: $BlockPos_, state: $BlockState_, alwaysPlace: boolean): $BlockState;
        isStraight(): boolean;
        pickupBlock(player: $Player | null, level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_): $ItemStack;
        placeLiquid(level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_, fluidState: $FluidState): boolean;
        canPlaceLiquid(player: $Player | null, level: $BlockGetter, pos: $BlockPos_, state: $BlockState_, fluid: $Fluid): boolean;
         ...
         */
        getRailMaxSpeed(state: $BlockState_, level: $Level, pos: $BlockPos_, cart: $AbstractMinecart): number;
        /**
         * This function is called by any minecart that passes over this rail.
         * It is called once per update tick that the minecart is on the rail.
         */
        onMinecartPass(state: $BlockState_, level: $Level, pos: $BlockPos_, cart: $AbstractMinecart): void;
        /**
    ...
    export class $ObserverBlock extends $DirectionalBlock {
        wrapWithCondition$bhk000$supplementaries$supp$preventSlidyBlockUpdates(arg0: $ObserverBlock, arg1: $LevelAccessor, arg2: $BlockPos_, arg3: $BlockState_): boolean;
        updateNeighborsInFront(level: $Level, pos: $BlockPos_, state: $BlockState_): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $FlowerPotBlock extends $Block {
        ...
        handler$gfm000$amendments$addPotSound(arg0: $ItemStack_, arg1: $BlockState_, arg2: $Level, arg3: $BlockPos_, arg4: $Player, arg5: $InteractionHand_, arg6: $BlockHitResult, arg7: $CallbackInfoReturnable<any>): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
         ...
         * @deprecated
         */
        constructor(potted: $Block, properties: $BlockBehaviour$Properties);
        get potted(): $Block;
    ...
    export class $AttachedStemBlock extends $BushBlock {
        handler$iji001$immersive_weathering$mayPlaceOn(blockState: $BlockState_, blockGetter: $BlockGetter, blockPos: $BlockPos_, cir: $CallbackInfoReturnable<any>): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $TurtleEggBlock extends $Block {
        handler$jhj000$axiom$fallOn(ci: $CallbackInfo, level: $Level, entity: $Entity): void;
        handler$jhk000$axiom$stepOn(ci: $CallbackInfo, level: $Level, entity: $Entity): void;
    ...
    export class $AbstractFurnaceBlock extends $BaseEntityBlock {
         ...
         * @see #use
         */
        openContainer(level: $Level, pos: $BlockPos_, player: $Player): void;
        static createFurnaceTicker<T extends $BlockEntity>(level: $Level, serverType: $BlockEntityType<T>, clientType: $BlockEntityType<$AbstractFurnaceBlockEntity>): $BlockEntityTicker<T>;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $BambooSaplingBlock extends $Block implements $BonemealableBlock {
        performBonemeal(level: $ServerLevel, random: $RandomSource, pos: $BlockPos_, state: $BlockState_): void;
        isBonemealSuccess(level: $Level, random: $RandomSource, pos: $BlockPos_, state: $BlockState_): boolean;
        handler$ijj000$immersive_weathering$iw$canSurviveOnIwSoil(state: $BlockState_, level: $LevelReader, pos: $BlockPos_, cir: $CallbackInfoReturnable<any>): void;
        growBamboo(level: $Level, state: $BlockPos_): void;
        isValidBonemealTarget(level: $LevelReader, pos: $BlockPos_, state: $BlockState_): boolean;
        getType(): $BonemealableBlock$Type;
        getParticlePos(pos: $BlockPos_): $BlockPos;
        explosionResistance: number;
    ...
    export class $CeilingHangingSignBlock extends $SignBlock implements $EntityBlock {
        handler$gfj000$amendments$use(arg0: $ItemStack_, arg1: $BlockState_, arg2: $Level, arg3: $BlockPos_, arg4: $Player, arg5: $InteractionHand_, arg6: $BlockHitResult, arg7: $CallbackInfoReturnable<any>): void;
        handler$gfj000$amendments$updateExtension(arg0: $BlockState_, arg1: $Direction_, arg2: $BlockState_, arg3: $LevelAccessor, arg4: $BlockPos_, arg5: $BlockPos_, arg6: $CallbackInfoReturnable<any>): void;
        static ROTATION: $IntegerProperty;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
    ...
    export class $BushBlock extends $Block {
        ...
        handler$ijo002$immersive_weathering$mayPlaceOn(state: $BlockState_, level: $BlockGetter, pos: $BlockPos_, cir: $CallbackInfoReturnable<any>): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $WitherSkullBlock extends $SkullBlock {
        static checkSpawn(level: $Level, pos: $BlockPos_): void;
        static checkSpawn(level: $Level, pos: $BlockPos_, blockEntity: $SkullBlockEntity): void;
        static canSpawnMob(level: $Level, pos: $BlockPos_, stack: $ItemStack_): boolean;
        static ROTATION: $IntegerProperty;
        explosionResistance: number;
        static MAX: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
    ...
    export class $BrushableBlock extends $BaseEntityBlock implements $Fallable {
        getTurnsInto(): $Block;
        onBrokenAfterFall(level: $Level, pos: $BlockPos_, fallingBlock: $FallingBlockEntity): void;
        getBrushSound(): $SoundEvent;
        handler$jhn000$axiom$onPlace(blockState: $BlockState_, level: $Level, blockPos: $BlockPos_, blockState2: $BlockState_, bl: boolean, ci: $CallbackInfo): void;
        handler$jhn001$axiom$updateShape(blockState: $BlockState_, direction: $Direction_, blockState2: $BlockState_, levelAccessor: $LevelAccessor, blockPos: $BlockPos_, blockPos2: $BlockPos_, cir: $CallbackInfoReturnable<any>): void;
        handler$jhn000$axiom$tick(blockState: $BlockState_, serverLevel: $ServerLevel, blockPos: $BlockPos_, randomSource: $RandomSource, ci: $CallbackInfo): void;
        getBrushCompletedSound(): $SoundEvent;
        onLand(level: $Level, pos: $BlockPos_, state: $BlockState_, replaceableState: $BlockState_, fallingBlock: $FallingBlockEntity): void;
        ...
        static UPDATE_CLIENTS: number;
        hasCollision: boolean;
        constructor(turnsInto: $Block, brushSound: $SoundEvent, brushCompletedSound: $SoundEvent, properties: $BlockBehaviour$Properties);
        get turnsInto(): $Block;
    ...
    export class $WallBlock extends $Block implements $SimpleWaterloggedBlock {
        handler$dlg000$immersiveengineering$deflection(arg0: $BlockState_, arg1: boolean, arg2: $Direction_, arg3: $CallbackInfoReturnable<any>): void;
        pickupBlock(player: $Player | null, level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_): $ItemStack;
        placeLiquid(level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_, fluidState: $FluidState): boolean;
        canPlaceLiquid(player: $Player | null, level: $BlockGetter, pos: $BlockPos_, state: $BlockState_, fluid: $Fluid): boolean;
        getPickupSound(): ($SoundEvent) | undefined;
    ...
    export class $FaceAttachedHorizontalDirectionalBlock extends $HorizontalDirectionalBlock {
        ...
        redirect$jlb001$axiom$getStateForPlacementCanSurvive(state: $BlockState_, level: $LevelReader, pos: $BlockPos_): boolean;
        static getConnectedDirection(state: $BlockState_): $Direction;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
    ...
    export class $SugarCaneBlock extends $Block {
        handler$iko000$immersive_weathering$canPlaceAt(state: $BlockState_, level: $LevelReader, pos: $BlockPos_, cir: $CallbackInfoReturnable<any>): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $BeehiveBlock extends $BaseEntityBlock implements $BlockWithSubLevelCollisionCallback {
        sable$getCallback(): $BlockSubLevelCollisionCallback;
        releaseBeesAndResetHoneyLevel(level: $Level, state: $BlockState_, pos: $BlockPos_, player: $Player | null, beeReleaseStatus: $BeehiveBlockEntity$BeeReleaseStatus_): void;
        resetHoneyLevel(level: $Level, state: $BlockState_, pos: $BlockPos_): void;
        static dropHoneycomb(level: $Level, pos: $BlockPos_): void;
        explosionResistance: number;
    ...
    export class $FallingBlock extends $Block implements $Fallable {
        ...
        handler$jhp001$axiom$onPlace(blockState: $BlockState_, level: $Level, blockPos: $BlockPos_, blockState2: $BlockState_, bl: boolean, ci: $CallbackInfo): void;
        handler$jhp002$axiom$updateShape(blockState: $BlockState_, direction: $Direction_, blockState2: $BlockState_, levelAccessor: $LevelAccessor, blockPos: $BlockPos_, blockPos2: $BlockPos_, cir: $CallbackInfoReturnable<any>): void;
        static isFree(state: $BlockState_): boolean;
        handler$jhp001$axiom$tick(blockState: $BlockState_, serverLevel: $ServerLevel, blockPos: $BlockPos_, randomSource: $RandomSource, ci: $CallbackInfo): void;
        onBrokenAfterFall(level: $Level, pos: $BlockPos_, fallingBlock: $FallingBlockEntity): void;
        onLand(level: $Level, pos: $BlockPos_, state: $BlockState_, replaceableState: $BlockState_, fallingBlock: $FallingBlockEntity): void;
        getFallDamageSource(entity: $Entity): $DamageSource;
        explosionResistance: number;
    ...
    export class $Blocks {
        ...
        static register(key: string, block: $Block): $Block;
        static register(resourceKey: $ResourceKey_<$Block>, block: $Block): $Block;
        ...
        static ocelotOrParrot(state: $BlockState_, blockGetter: $BlockGetter, pos: $BlockPos_, entity: $EntityType<never>): boolean;
        static rebuildCache(): void;
        static always(state: $BlockState_, blockGetter: $BlockGetter, pos: $BlockPos_): boolean;
        static always(state: $BlockState_, blockGetter: $BlockGetter, pos: $BlockPos_, entity: $EntityType<never>): boolean;
        static leaves(soundType: $SoundType_): $Block;
        static never(state: $BlockState_, blockGetter: $BlockGetter, pos: $BlockPos_, entity: $EntityType<never>): boolean;
        static never(state: $BlockState_, blockGetter: $BlockGetter, pos: $BlockPos_): boolean;
        static netherStem(mapColor: $MapColor): $Block;
        static flowerPot(potted: $Block): $Block;
    ...
    export class $CampfireBlock extends $BaseEntityBlock implements $SimpleWaterloggedBlock {
        ...
        static makeParticles(level: $Level, pos: $BlockPos_, isSignalFire: boolean, spawnExtraSmoke: boolean): void;
        static isLitCampfire(state: $BlockState_): boolean;
        static isSmokeyPos(level: $Level, pos: $BlockPos_): boolean;
        handler$fjc000$farmersdelight$isFDSmokeSource(arg0: $BlockState_, arg1: $CallbackInfoReturnable<any>): void;
        handler$bfp000$supplementaries$supp$isSmokeSource(arg0: $BlockState_, arg1: $CallbackInfoReturnable<any>): void;
        pickupBlock(player: $Player | null, level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_): $ItemStack;
        canPlaceLiquid(player: $Player | null, level: $BlockGetter, pos: $BlockPos_, state: $BlockState_, fluid: $Fluid): boolean;
        getPickupSound(): ($SoundEvent) | undefined;
        /**
    ...
    export class $TripWireBlock extends $Block {
        ...
        localvar$zdc000$openpartiesandclaims$onCheckPressed(arg0: $List_<any>, arg1: $Level, arg2: $BlockPos_): $List<any>;
        explosionResistance: number;
        static WEST: $BooleanProperty;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        ...
        static AABB: $VoxelShape;
        hasCollision: boolean;
        constructor(hook: $Block, properties: $BlockBehaviour$Properties);
    }
    ...
    export class $CropBlock extends $BushBlock implements $BonemealableBlock, $CropBlockAccess, $AccessorCropBlock, $CropBlockAccessor {
        growCrops(level: $Level, pos: $BlockPos_, state: $BlockState_): void;
        performBonemeal(level: $ServerLevel, random: $RandomSource, pos: $BlockPos_, state: $BlockState_): void;
        isBonemealSuccess(level: $Level, random: $RandomSource, pos: $BlockPos_, state: $BlockState_): boolean;
        ...
        handler$ikb000$immersive_weathering$canPlantOnTop(floor: $BlockState_, world: $BlockGetter, pos: $BlockPos_, cir: $CallbackInfoReturnable<any>): void;
        isValidBonemealTarget(level: $LevelReader, pos: $BlockPos_, state: $BlockState_): boolean;
        getBonemealAgeIncrease(level: $Level): number;
        getType(): $BonemealableBlock$Type;
        getParticlePos(pos: $BlockPos_): $BlockPos;
    ...
    export class $FireBlock extends $BaseFireBlock implements $FireBlockAccessor, $FireBlockHooks, $FireBlockAccessor$1, $FireBlockInvoker {
        static bootStrap(): void;
        setFlammable(block: $Block, encouragement: number, flammability: number): void;
        ...
        modifyExpressionValue$bgl000$supplementaries$supp$igniteLumisene(arg0: number, arg1: $ServerLevel, arg2: $BlockPos$MutableBlockPos, arg3: $LocalBooleanRef): number;
        wrapOperation$bgl000$supplementaries$supp$doIgniteLumisene(arg0: $ServerLevel, arg1: $BlockPos_, arg2: $BlockState_, arg3: number, arg4: $Operation_<any>, arg5: $LocalBooleanRef): boolean;
        ...
        handler$zdg000$openpartiesandclaims$onCheckBurnOut(arg0: $Level, arg1: $BlockPos_, arg2: number, arg3: $RandomSource, arg4: number, arg5: $Direction_, arg6: $CallbackInfo): void;
        handler$zca000$openpartiesandclaims$onGetFireOdds(arg0: $LevelReader, arg1: $BlockPos_, arg2: $CallbackInfoReturnable<any>): void;
        isNearRain(level: $Level, pos: $BlockPos_): boolean;
        invokeSetFlammable(block: $Block, encouragement: number, flammability: number): void;
        invokeTryCatchFire(arg0: $Level, arg1: $BlockPos_, arg2: number, arg3: $RandomSource, arg4: number, arg5: $Direction_): void;
    ...
    export class $InfestedBlock extends $Block {
        ...
        static UPDATE_CLIENTS: number;
        hasCollision: boolean;
        constructor(hostBlock: $Block, properties: $BlockBehaviour$Properties);
        get hostBlock(): $Block;
    }
    ...
    export class $PoweredRailBlock extends $BaseRailBlock {
        ...
        findPoweredRailSignal(level: $Level, pos: $BlockPos_, state: $BlockState_, searchForward: boolean, recursionCount: number): boolean;
        isSameRailWithPower(level: $Level, state: $BlockPos_, searchForward: boolean, recursionCount: number, shape: $RailShape_): boolean;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $TargetBlock extends $Block {
        handler$zdb000$openpartiesandclaims$onOnProjectileHit(arg0: $Level, arg1: $BlockState_, arg2: $BlockHitResult, arg3: $Projectile, arg4: $CallbackInfo): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $EquipableCarvedPumpkinBlock extends $CarvedPumpkinBlock implements $Equipable {
        getEquipmentSlot(): $EquipmentSlot;
        getEquipSound(): $Holder<$SoundEvent>;
        swapWithEquipmentSlot(arg0: $Item, arg1: $Level, arg2: $Player, arg3: $InteractionHand_): $InteractionResultHolder<$ItemStack>;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $DeadBushBlock extends $BushBlock implements $IShearable {
        handler$ika000$immersive_weathering$iw$mayPlaceOnIwSoil(state: $BlockState_, level: $BlockGetter, pos: $BlockPos_, cir: $CallbackInfoReturnable<any>): void;
        /**
         * Spawns the given stack into the Level at the given position, respecting the doTileDrops gamerule
         */
        spawnShearedDrop(level: $Level, pos: $BlockPos_, stack: $ItemStack_): void;
    ...
    export class $InfestedRotatedPillarBlock extends $InfestedBlock {
        ...
        static UPDATE_CLIENTS: number;
        hasCollision: boolean;
        constructor(arg0: $Block, arg1: $BlockBehaviour$Properties);
    }
    export class $DiodeBlock extends $HorizontalDirectionalBlock {
        ...
        shouldTurnOn(level: $Level, pos: $BlockPos_, state: $BlockState_): boolean;
        ...
        getInputSignal(level: $Level, pos: $BlockPos_, state: $BlockState_): number;
         ...
         */
        checkTickOnNeighbor(level: $Level, pos: $BlockPos_, state: $BlockState_): void;
        /**
         * Check the output signal of this diode and schedule a new block tick if it should change.
         */
        updateNeighborsInFront(level: $Level, pos: $BlockPos_, state: $BlockState_): void;
    ...
    export class $ShulkerBoxBlock extends $BaseEntityBlock {
        getColor(): $DyeColor;
        static getColorFromItem(item: $Item): $DyeColor;
        static getBlockByColor(color: $DyeColor_ | null): $Block;
        static getColorFromBlock(block: $Block): $DyeColor;
    ...
    export class $SpongeBlock extends $Block {
        tryAbsorbWater(level: $Level, pos: $BlockPos_): void;
        explosionResistance: number;
    ...
    export class $StairBlock extends $Block implements $SimpleWaterloggedBlock {
        handler$jjl000$axiom$mirror(blockState: $BlockState_, mirror: $Mirror_, cir: $CallbackInfoReturnable<any>): void;
    ...
    export class $SmallDripleafBlock extends $DoublePlantBlock implements $BonemealableBlock, $SimpleWaterloggedBlock {
        performBonemeal(arg0: $ServerLevel, arg1: $RandomSource, arg2: $BlockPos_, arg3: $BlockState_): void;
        isBonemealSuccess(arg0: $Level, arg1: $RandomSource, arg2: $BlockPos_, arg3: $BlockState_): boolean;
        redirect$jlf001$axiom$setPlacedByIsClientSide(instance: $Level): boolean;
        isValidBonemealTarget(arg0: $LevelReader, arg1: $BlockPos_, arg2: $BlockState_): boolean;
        getType(): $BonemealableBlock$Type;
        getParticlePos(arg0: $BlockPos_): $BlockPos;
        pickupBlock(arg0: $Player | null, arg1: $LevelAccessor, arg2: $BlockPos_, arg3: $BlockState_): $ItemStack;
    ...
    export class $StructureVoidBlock extends $Block {
        modifyReturnValue$jka001$axiom$getShape(voxelShape: $RenderShape_): $RenderShape;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $WallSignBlock extends $SignBlock {
        modifyReturnValue$ggl000$amendments$getShape(arg0: $VoxelShape, arg1: $BlockState_, arg2: $BlockGetter, arg3: $BlockPos_, arg4: $CollisionContext): $VoxelShape;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $VineBlock extends $Block implements $IShearable {
        ...
        wrapOperation$hdb000$sable$stopSpreadBeyondSubLevel(arg0: $ServerLevel, arg1: $BlockPos_, arg2: $BlockState_, arg3: number, arg4: $Operation_<any>, arg5: $BlockPos_): boolean;
        wrapOperation$hdb000$sable$stopSpreadBeyondSubLevel$mixinextras$bridge$26(arg0: $ServerLevel, arg1: $BlockPos_, arg2: $BlockState_, arg3: number, arg4: $Operation_<any>, arg5: $LocalRef<any>): boolean;
    ...
    export class $CrafterBlock extends $BaseEntityBlock {
        ...
        static getPotentialResults(level: $Level, input: $CraftingInput): ($RecipeHolder<$CraftingRecipe>) | undefined;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $RedstoneTorchBlock extends $BaseTorchBlock {
        hasNeighborSignal(level: $Level, pos: $BlockPos_, state: $BlockState_): boolean;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
    ...
    export class $FarmBlock extends $Block {
        static turnToDirt(entity: $Entity | null, state: $BlockState_, level: $Level, pos: $BlockPos_): void;
        handler$jhj000$axiom$fallOn(ci: $CallbackInfo, level: $Level, entity: $Entity): void;
        wrapOperation$jia000$axiom$fallOnTurnToDirt(entity: $Entity, blockState: $BlockState_, level: $Level, blockPos: $BlockPos_, original: $Operation_<any>): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $SnowLayerBlock extends $Block {
        handler$ikm000$immersive_weathering$melt(blockState: $BlockState_, serverLevel: $ServerLevel, blockPos: $BlockPos_, randomSource: $RandomSource, ci: $CallbackInfo): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $StemBlock extends $BushBlock implements $BonemealableBlock {
        performBonemeal(level: $ServerLevel, random: $RandomSource, pos: $BlockPos_, state: $BlockState_): void;
        isBonemealSuccess(level: $Level, random: $RandomSource, pos: $BlockPos_, state: $BlockState_): boolean;
        handler$ikn003$immersive_weathering$mayPlaceOn(blockState: $BlockState_, blockGetter: $BlockGetter, blockPos: $BlockPos_, cir: $CallbackInfoReturnable<any>): void;
        isValidBonemealTarget(level: $LevelReader, pos: $BlockPos_, state: $BlockState_): boolean;
        getType(): $BonemealableBlock$Type;
        getParticlePos(pos: $BlockPos_): $BlockPos;
        explosionResistance: number;
    ...
    export class $LecternBlock extends $BaseEntityBlock {
        static resetBookState(entity: $Entity | null, level: $Level, pos: $BlockPos_, state: $BlockState_, hasBook: boolean): void;
        static signalPageChange(level: $Level, pos: $BlockPos_, state: $BlockState_): void;
        static tryPlaceBook(entity: $LivingEntity | null, level: $Level, pos: $BlockPos_, state: $BlockState_, stack: $ItemStack_): boolean;
        handler$ggb000$amendments$openCustomMenu(arg0: $Level, arg1: $BlockPos_, arg2: $Player, arg3: $CallbackInfo): void;
    ...
    export class $MudBlock extends $Block {
        handler$ikh000$immersive_weathering$getCollisionShape(state: $BlockState_, level: $BlockGetter, pos: $BlockPos_, context: $CollisionContext, cir: $CallbackInfoReturnable<any>): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $ChorusFlowerBlock extends $Block {
        ...
        static UPDATE_CLIENTS: number;
        hasCollision: boolean;
        constructor(plant: $Block, properties: $BlockBehaviour$Properties);
    }
    ...
    export class $WeatheringCopper {
        ...
        static getFirst(block: $Block): $Block;
        static getPrevious(state: $BlockState_): ($BlockState) | undefined;
        static getPrevious(block: $Block): ($Block) | undefined;
        static getNext(block: $Block): ($Block) | undefined;
        /**
         * @deprecated
         */
    ...
    export class $ButtonBlock extends $FaceAttachedHorizontalDirectionalBlock {
        checkPressed(state: $BlockState_, level: $Level, pos: $BlockPos_): void;
        getSound(isOn: boolean): $SoundEvent;
        playSound(player: $Player | null, level: $LevelAccessor, pos: $BlockPos_, hitByArrow: boolean): void;
        press(state: $BlockState_, level: $Level, pos: $BlockPos_, player: $Player | null): void;
        handler$zdj000$openpartiesandclaims$onCheckPressed(arg0: $BlockState_, arg1: $Level, arg2: $BlockPos_, arg3: $CallbackInfo): void;
    ...
    export class $Block extends $BlockBehaviour implements $ItemLike, $IBlockExtension, $AccessorMixinBlock, $InjectedBlockExtension, $BlockKJS, $CustomBlock {
         ...
         */
        animateTick(state: $BlockState_, level: $Level, pos: $BlockPos_, random: $RandomSource): void;
        /**
         * @deprecated
         */
        getCloneItemStack(level: $LevelReader, pos: $BlockPos_, state: $BlockState_): $ItemStack;
        stepOn(level: $Level, pos: $BlockPos_, state: $BlockState_, entity: $Entity): void;
        fallOn(level: $Level, state: $BlockState_, pos: $BlockPos_, entity: $Entity, fallDistance: number): void;
        /**
        ...
        spawnDestroyParticles(level: $Level, player: $Player, pos: $BlockPos_, state: $BlockState_): void;
        handlePrecipitation(state: $BlockState_, level: $Level, pos: $BlockPos_, precipitation: $Biome$Precipitation_): void;
        ...
        createBlockStateDefinition(builder: $StateDefinition$Builder<$Block, $BlockState_>): void;
        static popResourceFromFace(level: $Level, pos: $BlockPos_, direction: $Direction_, stack: $ItemStack_): void;
        /**
        ...
        static byItem(item: $Item | null): $Block;
         ...
         */
        playerDestroy(level: $Level, player: $Player, pos: $BlockPos_, state: $BlockState_, blockEntity: $BlockEntity | null, tool: $ItemStack_): void;
        /**
         * Called when this Block is destroyed by an Explosion
         */
        wasExploded(level: $Level, pos: $BlockPos_, explosion: $Explosion): void;
        /**
        ...
        static popResource(itemStack: $Level, arg1: $BlockPos_, arg2: $ItemStack_): void;
        /**
         ...
         */
        setPlacedBy(level: $Level, pos: $BlockPos_, state: $BlockState_, placer: $LivingEntity | null, stack: $ItemStack_): void;
        ...
        static dropResources(state: $BlockState_, level: $Level, pos: $BlockPos_, blockEntity: $BlockEntity | null, entity: $Entity | null, tool: $ItemStack_): void;
        static dropResources(state: $BlockState_, level: $Level, pos: $BlockPos_): void;
         ...
         */
        setBedOccupied(state: $BlockState_, level: $Level, pos: $BlockPos_, sleeper: $LivingEntity, occupied: boolean): void;
        /**
         ...
         */
        addRunningEffects(state: $BlockState_, level: $Level, pos: $BlockPos_, entity: $Entity): boolean;
        /**
         ...
         * server sides!
         */
        onDestroyedByPushReaction(state: $BlockState_, level: $Level, pos: $BlockPos_, pushDirection: $Direction_, fluid: $FluidState): void;
        /**
         ...
         */
        onDestroyedByPlayer(state: $BlockState_, level: $Level, pos: $BlockPos_, player: $Player, willHarvest: boolean, fluid: $FluidState): boolean;
        /**
         ...
         */
        getRespawnPosition(state: $BlockState_, type: $EntityType<never>, levelReader: $LevelReader, pos: $BlockPos_, orientation: number): ($ServerPlayer$RespawnPosAngle) | undefined;
         ...
         */
        onCaughtFire(state: $BlockState_, level: $Level, pos: $BlockPos_, direction: $Direction_, igniter: $LivingEntity): void;
        /**
         ...
         */
        onBlockExploded(state: $BlockState_, level: $Level, pos: $BlockPos_, explosion: $Explosion): void;
        /**
        ...
        lootr$spawnDestroyParticles(level: $Level, player: $Player, pos: $BlockPos_, state: $BlockState_): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $NoteBlock extends $Block {
        ...
        handler$fld000$cataclysm$getMobHeadCustomSoundId(arg0: $Level, arg1: $BlockPos_, arg2: $CallbackInfoReturnable<any>): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $IceBlock extends $HalfTransparentBlock implements $IceBlockAccessor, $IceInvoker {
        /**
         * Gets the default state for this block
         */
        static meltsInto(): $BlockState;
        melt(state: $BlockState_, level: $Level, pos: $BlockPos_): void;
        invokeMelt(state: $BlockState_, level: $Level, pos: $BlockPos_): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $FenceGateBlock extends $HorizontalDirectionalBlock implements $FenceGateBlockAccessor {
        ...
        callUseWithoutItem(state: $BlockState_, level: $Level, pos: $BlockPos_, player: $Player, hitResult: $BlockHitResult): $InteractionResult;
        ...
        static FACING: $DirectionProperty;
        hasCollision: boolean;
        constructor(arg0: ($WoodType_) | undefined, arg1: $BlockBehaviour$Properties, arg2: ($SoundEvent) | undefined, arg3: ($SoundEvent) | undefined);
        constructor(arg0: $BlockBehaviour$Properties, arg1: $SoundEvent, arg2: $SoundEvent);
        constructor(type: $WoodType_, properties: $BlockBehaviour$Properties);
    }
    ...
    export class $ChestBlock extends $AbstractChestBlock<$ChestBlockEntity> implements $SimpleWaterloggedBlock {
        ...
        static getContainer(chest: $ChestBlock, state: $BlockState_, level: $Level, pos: $BlockPos_, override: boolean): $Container;
    ...
    export class $LightBlock extends $Block implements $SimpleWaterloggedBlock {
        ...
        modifyReturnValue$jjo000$axiom$getShape(voxelShape: $RenderShape_): $RenderShape;
        modifyReturnValue$jjo000$axiom$getShape(voxelShape: $VoxelShape, context: $CollisionContext): $VoxelShape;
        pickupBlock(player: $Player | null, level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_): $ItemStack;
        placeLiquid(level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_, fluidState: $FluidState): boolean;
        canPlaceLiquid(player: $Player | null, level: $BlockGetter, pos: $BlockPos_, state: $BlockState_, fluid: $Fluid): boolean;
        getPickupSound(): ($SoundEvent) | undefined;
    ...
    export class $CauldronBlock extends $AbstractCauldronBlock {
        handler$gfi000$amendments$handleModdedFluid(arg0: $BlockState_, arg1: $Level, arg2: $BlockPos_, arg3: $Fluid, arg4: $CallbackInfo): void;
        handler$gfi000$amendments$TweakLava(arg0: $BlockState_, arg1: $Level, arg2: $BlockPos_, arg3: $Fluid, arg4: $CallbackInfo): void;
        static shouldHandlePrecipitation(level: $Level, precipitation: $Biome$Precipitation_): boolean;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static FLOOR_LEVEL: number;
    ...
    export class $BlockTypes {
        static bootstrap(registry: $Registry<$MapCodec<$Block>>): $MapCodec<$Block>;
        static CODEC: $MapCodec<$Block>;
        constructor();
    }
    ...
    export class $TripWireHookBlock extends $Block {
        static calculateState(level: $Level, pos: $BlockPos_, hookState: $BlockState_, attaching: boolean, shouldNotifyNeighbours: boolean, searchRange: number, state: $BlockState_ | null): void;
        static SOUTH_AABB: $VoxelShape;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
    ...
    export class $CarvedPumpkinBlock extends $HorizontalDirectionalBlock {
        ...
        static clearPatternBlocks(level: $Level, patternMatch: $BlockPattern$BlockPatternMatch): void;
        static updatePatternBlocks(level: $Level, patternMatch: $BlockPattern$BlockPatternMatch): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $LadderBlock extends $Block implements $SimpleWaterloggedBlock {
        modifyReturnValue$jlc000$axiom$getStateForPlacementReturn(blockState: $BlockState_, blockPlaceContext: $BlockPlaceContext): $BlockState;
        pickupBlock(player: $Player | null, level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_): $ItemStack;
        placeLiquid(level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_, fluidState: $FluidState): boolean;
        canPlaceLiquid(player: $Player | null, level: $BlockGetter, pos: $BlockPos_, state: $BlockState_, fluid: $Fluid): boolean;
        getPickupSound(): ($SoundEvent) | undefined;
    ...
    export class $LiquidBlock extends $Block implements $BucketPickup, $LiquidBlockAccessor, $InjectedLiquidBlockExtension {
        pickupBlock(player: $Player | null, level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_): $ItemStack;
        getOwnFluid(): $FlowingFluid;
        handler$jjp001$axiom$getShape(blockState: $BlockState_, blockGetter: $BlockGetter, blockPos: $BlockPos_, context: $CollisionContext, cir: $CallbackInfoReturnable<any>): void;
        handler$jjn000$axiom$getShape(blockState: $BlockState_, blockGetter: $BlockGetter, blockPos: $BlockPos_, context: $CollisionContext, cir: $CallbackInfoReturnable<any>): void;
        getPickupSound(): ($SoundEvent) | undefined;
    ...
    export class $PointedDripstoneBlock extends $Block implements $Fallable, $SimpleWaterloggedBlock {
        onBrokenAfterFall(level: $Level, pos: $BlockPos_, fallingBlock: $FallingBlockEntity): void;
        static findStalactiteTipAboveCauldron(level: $Level, pos: $BlockPos_): $BlockPos;
        static maybeTransferFluid(state: $BlockState_, level: $ServerLevel, pos: $BlockPos_, randChance: number): void;
        static spawnDripParticle(level: $Level, pos: $BlockPos_, state: $BlockState_): void;
    ...
    export class $CaveVines {
        static use(entity: $Entity | null, state: $BlockState_, level: $Level, pos: $BlockPos_): $InteractionResult;
    ...
    export class $DetectorRailBlock extends $BaseRailBlock {
        registerDefaultState(): void;
        updatePowerToConnected(level: $Level, pos: $BlockPos_, state: $BlockState_, powered: boolean): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $BasePressurePlateBlock extends $Block {
         ...
         */
        getSignalStrength(level: $Level, pos: $BlockPos_): number;
        /**
         * Returns the signal encoded in the given block state.
         */
        getSignalForState(state: $BlockState_): number;
        static getEntityCount(level: $Level, box: $AABB_, entityClass: $Class<$Entity>): number;
         ...
         */
        updateNeighbours(level: $Level, pos: $BlockPos_): void;
        handler$zbj000$openpartiesandclaims$onCheckPressedPre(arg0: $Entity, arg1: $Level, arg2: $BlockPos_, arg3: $BlockState_, arg4: number, arg5: $CallbackInfo): void;
        handler$zbj000$openpartiesandclaims$onCheckPressedPost(arg0: $Entity, arg1: $Level, arg2: $BlockPos_, arg3: $BlockState_, arg4: number, arg5: $CallbackInfo): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        type: $BlockSetType;
    ...
    export class $FungusBlock extends $BushBlock implements $BonemealableBlock {
        ...
        static UPDATE_CLIENTS: number;
        hasCollision: boolean;
        constructor(feature: $ResourceKey_<$ConfiguredFeature<never, never>>, requiredBlock: $Block, properties: $BlockBehaviour$Properties);
        get type(): $BonemealableBlock$Type;
    }
    ...
    export class $SculkSensorBlock extends $BaseEntityBlock implements $SimpleWaterloggedBlock {
        ...
        static deactivate(level: $Level, pos: $BlockPos_, state: $BlockState_): void;
        activate(entity: $Entity | null, level: $Level, pos: $BlockPos_, state: $BlockState_, power: number, frequency: number): void;
        handler$jhk000$axiom$stepOn(ci: $CallbackInfo, level: $Level, entity: $Entity): void;
        getActiveTicks(): number;
        static canActivate(state: $BlockState_): boolean;
        static tryResonateVibration(entity: $Entity | null, level: $Level, pos: $BlockPos_, frequency: number): void;
        pickupBlock(player: $Player | null, level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_): $ItemStack;
        placeLiquid(level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_, fluidState: $FluidState): boolean;
        canPlaceLiquid(player: $Player | null, level: $BlockGetter, pos: $BlockPos_, state: $BlockState_, fluid: $Fluid): boolean;
        getPickupSound(): ($SoundEvent) | undefined;
    ...
    export class $AbstractCauldronBlock extends $Block {
        ...
        modifyReturnValue$gfd000$amendments$use(arg0: $ItemInteractionResult_, arg1: $ItemStack_, arg2: $BlockState_, arg3: $Level, arg4: $BlockPos_, arg5: $Player, arg6: $InteractionHand_, arg7: $BlockHitResult): $ItemInteractionResult;
        receiveStalactiteDrip(state: $BlockState_, level: $Level, pos: $BlockPos_, fluid: $Fluid): void;
        canReceiveStalactiteDrip(fluid: $Fluid): boolean;
    ...
    export class $TrapDoorBlock extends $HorizontalDirectionalBlock implements $SimpleWaterloggedBlock {
        ...
        playSound(player: $Player | null, level: $Level, pos: $BlockPos_, isOpened: boolean): void;
        pickupBlock(player: $Player | null, level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_): $ItemStack;
        placeLiquid(level: $LevelAccessor, pos: $BlockPos_, state: $BlockState_, fluidState: $FluidState): boolean;
        canPlaceLiquid(player: $Player | null, level: $BlockGetter, pos: $BlockPos_, state: $BlockState_, fluid: $Fluid): boolean;
        getPickupSound(): ($SoundEvent) | undefined;
    ...
    export class $RespawnAnchorBlock extends $Block {
        ...
        static canSetSpawn(level: $Level): boolean;
        static charge(entity: $Entity | null, level: $Level, pos: $BlockPos_, state: $BlockState_): void;
        static findStandUpPosition(entityType: $EntityType<never>, level: $CollisionGetter, pos: $BlockPos_): ($Vec3) | undefined;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
        static UPDATE_INVISIBLE: number;
    ...
    export class $WallHangingSignBlock extends $SignBlock implements $EntityBlock {
        ...
        handler$gfj000$amendments$use(arg0: $ItemStack_, arg1: $BlockState_, arg2: $Level, arg3: $BlockPos_, arg4: $Player, arg5: $InteractionHand_, arg6: $BlockHitResult, arg7: $CallbackInfoReturnable<any>): void;
        handler$ggk000$amendments$canAttachTo(arg0: $LevelReader, arg1: $BlockState_, arg2: $BlockPos_, arg3: $Direction_, arg4: $CallbackInfoReturnable<any>, arg5: $BlockState_): void;
        handler$gfj000$amendments$updateExtension(arg0: $BlockState_, arg1: $Direction_, arg2: $BlockState_, arg3: $LevelAccessor, arg4: $BlockPos_, arg5: $BlockPos_, arg6: $CallbackInfoReturnable<any>): void;
        explosionResistance: number;
        static UPDATE_SHAPE_ORDER: $Direction[];
        static UPDATE_NONE: number;
    ...
    export class $BedBlock extends $HorizontalDirectionalBlock implements $EntityBlock {
        ...
        getColor(): $DyeColor;
        redirect$jkm000$axiom$setPlacedByIsClientSide(level: $Level): boolean;
        static findStandUpPosition(entityType: $EntityType<never>, collisionGetter: $CollisionGetter, pos: $BlockPos_, direction: $Direction_, yRot: number): ($Vec3) | undefined;
        static getConnectedDirection(state: $BlockState_): $Direction;
        getListener<T extends $BlockEntity>(level: $ServerLevel, blockEntity: T): $GameEventListener;
        getTicker<T extends $BlockEntity>(level: $Level, state: $BlockState_, blockEntityType: $BlockEntityType<T>): $BlockEntityTicker<T>;
