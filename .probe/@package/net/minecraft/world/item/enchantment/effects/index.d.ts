...
declare module "@package/net/minecraft/world/item/enchantment/effects" {
    ...
    export class $ReplaceBlock extends $Record implements $EnchantmentEntityEffect {
        ...
        modify$zcm000$openpartiesandclaims$replaceSetBlockPos(arg0: $BlockPos_): $BlockPos;
        handler$zcm000$openpartiesandclaims$onApplyHead(arg0: $ServerLevel, arg1: number, arg2: $EnchantedItemInUse_, arg3: $Entity, arg4: $Vec3_, arg5: $CallbackInfo): void;
        handler$zcm000$openpartiesandclaims$onApplyReturn(arg0: $ServerLevel, arg1: number, arg2: $EnchantedItemInUse_, arg3: $Entity, arg4: $Vec3_, arg5: $CallbackInfo): void;
        onChangedBlock(level: $ServerLevel, enchantmentLevel: number, item: $EnchantedItemInUse_, entity: $Entity, pos: $Vec3_, applyTransientEffects: boolean): void;
        onDeactivated(item: $EnchantedItemInUse_, entity: $Entity, pos: $Vec3_, enchantmentLevel: number): void;
    ...
    export class $EnchantmentEntityEffect {
        static bootstrap(registry: $Registry<$MapCodec<$EnchantmentEntityEffect>>): $MapCodec<$EnchantmentEntityEffect>;
    ...
    export class $EnchantmentLocationBasedEffect {
        static bootstrap(registry: $Registry<$MapCodec<$EnchantmentLocationBasedEffect>>): $MapCodec<$EnchantmentLocationBasedEffect>;
    ...
    export class $ReplaceDisk extends $Record implements $EnchantmentEntityEffect {
        ...
        blockState(): $BlockStateProvider;
        triggerGameEvent(): ($Holder<$GameEvent>) | undefined;
        localvar$zcn000$openpartiesandclaims$captureLevel(arg0: $BlockPos_, arg1: $ServerLevel, arg2: number, arg3: $EnchantedItemInUse_, arg4: $Entity, arg5: $Vec3_): $BlockPos;
        handler$zcn001$openpartiesandclaims$onApplyReturn(arg0: $ServerLevel, arg1: number, arg2: $EnchantedItemInUse_, arg3: $Entity, arg4: $Vec3_, arg5: $CallbackInfo): void;
        handler$zcn001$openpartiesandclaims$onApplyHead(arg0: $ServerLevel, arg1: number, arg2: $EnchantedItemInUse_, arg3: $Entity, arg4: $Vec3_, arg5: $CallbackInfo): void;
        onChangedBlock(level: $ServerLevel, enchantmentLevel: number, item: $EnchantedItemInUse_, entity: $Entity, pos: $Vec3_, applyTransientEffects: boolean): void;
        onDeactivated(item: $EnchantedItemInUse_, entity: $Entity, pos: $Vec3_, enchantmentLevel: number): void;
     ...
     */
    export type $SpawnParticlesEffect_ = { speed?: $FloatProvider, horizontalVelocity?: $SpawnParticlesEffect$VelocitySource_, verticalPosition?: $SpawnParticlesEffect$PositionSource_, verticalVelocity?: $SpawnParticlesEffect$VelocitySource_, horizontalPosition?: $SpawnParticlesEffect$PositionSource_, particle?: $ParticleOptions_,  } | [speed?: $FloatProvider, horizontalVelocity?: $SpawnParticlesEffect$VelocitySource_, verticalPosition?: $SpawnParticlesEffect$PositionSource_, verticalVelocity?: $SpawnParticlesEffect$VelocitySource_, horizontalPosition?: $SpawnParticlesEffect$PositionSource_, particle?: $ParticleOptions_, ];
    ...
    export class $EnchantmentValueEffect {
        static bootstrap(registry: $Registry<$MapCodec<$EnchantmentValueEffect>>): $MapCodec<$EnchantmentValueEffect>;
    ...
    export class $SetBlockProperties extends $Record implements $EnchantmentEntityEffect {
        ...
        triggerGameEvent(): ($Holder<$GameEvent>) | undefined;
        modify$zda001$openpartiesandclaims$replaceSetBlockPos(arg0: $BlockPos_): $BlockPos;
        handler$zda002$openpartiesandclaims$onApplyReturn(arg0: $ServerLevel, arg1: number, arg2: $EnchantedItemInUse_, arg3: $Entity, arg4: $Vec3_, arg5: $CallbackInfo): void;
        handler$zda002$openpartiesandclaims$onApplyHead(arg0: $ServerLevel, arg1: number, arg2: $EnchantedItemInUse_, arg3: $Entity, arg4: $Vec3_, arg5: $CallbackInfo): void;
        onChangedBlock(level: $ServerLevel, enchantmentLevel: number, item: $EnchantedItemInUse_, entity: $Entity, pos: $Vec3_, applyTransientEffects: boolean): void;
        onDeactivated(item: $EnchantedItemInUse_, entity: $Entity, pos: $Vec3_, enchantmentLevel: number): void;
