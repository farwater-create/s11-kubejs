...
import { $DataComponentType, $DataComponentMap, $DataComponentMap_, $DataComponentMap$Builder } from "@package/net/minecraft/core/component";
...
declare module "@package/net/minecraft/world/item/enchantment" {
    export class $EnchantmentHelper {
        ...
        static has(stack: $ItemStack_, componentType: $DataComponentType<never>): boolean;
        ...
        static getRandomItemWith(componentType: $DataComponentType<never>, entity: $LivingEntity, filter: $Predicate_<$ItemStack>): ($EnchantedItemInUse) | undefined;
        ...
        static pickHighestLevel<T>(stack: $ItemStack_, componentType: $DataComponentType<$List_<T>>): (T) | undefined;
        static getHighestLevel<T>(stack: $ItemStack_, componentType: $DataComponentType<T>): $Pair<T, number>;
    ...
    export class $Enchantment$Builder implements $EnchantmentBuilderAccessor {
        ...
        withEffect<E>(componentType: $DataComponentType<$List_<$ConditionalEffect_<E>>>, effect: E): $Enchantment$Builder;
        withEffect(componentType: $DataComponentType<$Unit_>): $Enchantment$Builder;
        withEffect<E>(componentType: $DataComponentType<$List_<$ConditionalEffect_<E>>>, effect: E, requirements: $LootItemCondition$Builder_): $Enchantment$Builder;
        withEffect<E>(componentType: $DataComponentType<$List_<$TargetedConditionalEffect_<E>>>, enchanted: $EnchantmentTarget_, affected: $EnchantmentTarget_, effect: E): $Enchantment$Builder;
        withEffect(componentType: $DataComponentType<$List_<$EnchantmentAttributeEffect_>>, effect: $EnchantmentAttributeEffect_): $Enchantment$Builder;
        withEffect<E>(componentType: $DataComponentType<$List_<$TargetedConditionalEffect_<E>>>, enchanted: $EnchantmentTarget_, affected: $EnchantmentTarget_, effect: E, requirements: $LootItemCondition$Builder_): $Enchantment$Builder;
        exclusiveWith(exclusiveSet: $HolderSet_<$Enchantment>): $Enchantment$Builder;
        withSpecialEffect<E>(componentType: $DataComponentType<E>, effect: E): $Enchantment$Builder;
        withCustomName(arg0: $UnaryOperator_<$MutableComponent>): $Enchantment$Builder;
        getDefinition(): $Enchantment$EnchantmentDefinition;
        invokeGetEffectsList<E>(componentType: $DataComponentType<$List_<E>>): $List<E>;
    ...
    export class $LevelBasedValue {
        ...
        static bootstrap(registry: $Registry<$MapCodec<$LevelBasedValue>>): $MapCodec<$LevelBasedValue>;
    ...
    export class $Enchantment extends $Record {
        ...
        modifyEntityFilteredValue(componentType: $DataComponentType<$List_<$ConditionalEffect_<$EnchantmentValueEffect>>>, level: $ServerLevel, enchantmentLevel: number, tool: $ItemStack_, entity: $Entity, value: $MutableFloat): void;
        modifyDamageFilteredValue(componentType: $DataComponentType<$List_<$ConditionalEffect_<$EnchantmentValueEffect>>>, level: $ServerLevel, enchantmentLevel: number, tool: $ItemStack_, entity: $Entity, damageSource: $DamageSource_, value: $MutableFloat): void;
        ...
        modifyItemFilteredCount(componentType: $DataComponentType<$List_<$ConditionalEffect_<$EnchantmentValueEffect>>>, level: $ServerLevel, enchantmentLevel: number, tool: $ItemStack_, value: $MutableFloat): void;
        ...
        modifyUnfilteredValue(componentType: $DataComponentType<$EnchantmentValueEffect>, random: $RandomSource, enchantmentLevel: number, value: $MutableFloat): void;
        ...
        getEffects<T>(component: $DataComponentType<$List_<T>>): $List<T>;
     ...
     */
    export type $Enchantment_ = { description?: $Component_, effects?: $DataComponentMap_, definition?: $Enchantment$EnchantmentDefinition_, exclusiveSet?: $HolderSet_<$Enchantment>,  } | [description?: $Component_, effects?: $DataComponentMap_, definition?: $Enchantment$EnchantmentDefinition_, exclusiveSet?: $HolderSet_<$Enchantment>, ];
    export class $EnchantmentEffectComponents {
        static bootstrap(registry: $Registry<$DataComponentType<never>>): $DataComponentType<never>;
