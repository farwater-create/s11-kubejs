import { $CommandSourceStack, $CommandBuildContext, $SharedSuggestionProvider } from "@package/net/minecraft/commands";
...
declare module "@package/net/minecraft/commands/synchronization" {
    ...
    export class $ArgumentTypeInfos {
        static bootstrap(registry: $Registry<$ArgumentTypeInfo<never, never>>): $ArgumentTypeInfo<never, never>;
