...
declare module "@package/net/minecraft/data/recipes/packs" {
    export class $VanillaRecipeProvider$TrimTemplate extends $Record {
        id(): $ResourceLocation;
        template(): $Item;
        constructor(arg0: $Item, arg1: $ResourceLocation_);
    }
    /**
     * Values that may be interpreted as {@link $VanillaRecipeProvider$TrimTemplate}.
     */
    export type $VanillaRecipeProvider$TrimTemplate_ = { id?: $ResourceLocation_, template?: $Item,  } | [id?: $ResourceLocation_, template?: $Item, ];
