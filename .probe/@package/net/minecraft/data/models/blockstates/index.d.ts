...
declare module "@package/net/minecraft/data/models/blockstates" {
    ...
    export class $MultiVariantGenerator implements $BlockStateGenerator {
        ...
        getBlock(): $Block;
        static multiVariant(block: $Block, ...variants: $Variant[]): $MultiVariantGenerator;
        static multiVariant(block: $Block): $MultiVariantGenerator;
        static multiVariant(block: $Block, variant: $Variant): $MultiVariantGenerator;
        get block(): $Block;
    }
    ...
    export class $MultiPartGenerator implements $BlockStateGenerator {
        ...
        getBlock(): $Block;
        static multiPart(block: $Block): $MultiPartGenerator;
        get block(): $Block;
    }
}
