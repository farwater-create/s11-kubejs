...
declare module "@package/net/minecraft/data/worldgen/placement" {
    ...
    export class $PlacementUtils {
        ...
        static bootstrap(context: $BootstrapContext<$PlacedFeature_>): void;
        static filteredByBlockSurvival(block: $Block): $BlockPredicateFilter;
    ...
    export class $OrePlacements {
        static bootstrap(context: $BootstrapContext<$PlacedFeature_>): void;
        static commonOrePlacement(count: number, heightRange: $PlacementModifier): $List<$PlacementModifier>;
    ...
    export class $VegetationPlacements {
        ...
        static treePlacement(placement: $PlacementModifier, saplingBlock: $Block): $List<$PlacementModifier>;
