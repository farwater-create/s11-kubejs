...
import { $StructureSet_, $Structure } from "@package/net/minecraft/world/level/levelgen/structure";
...
declare module "@package/net/minecraft/data/worldgen" {
    export class $ProcessorLists {
        static bootstrap(context: $BootstrapContext<$StructureProcessorList>): void;
    ...
    export class $BastionBridgePools {
        static bootstrap(context: $BootstrapContext<$StructureTemplatePool>): void;
        constructor();
    }
    ...
    export class $Pools {
        static register(context: $BootstrapContext<$StructureTemplatePool>, name: string, pool: $StructureTemplatePool): void;
        static bootstrap(context: $BootstrapContext<$StructureTemplatePool>): void;
    ...
    export class $Structures {
        static bootstrap(context: $BootstrapContext<$Structure>): void;
        constructor();
    }
