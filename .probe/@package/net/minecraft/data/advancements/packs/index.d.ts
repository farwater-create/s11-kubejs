...
declare module "@package/net/minecraft/data/advancements/packs" {
    export class $VanillaAdventureAdvancements implements $AdvancementSubProvider {
        ...
        static createMonsterHunterAdvancement(advancement: $AdvancementHolder_, output: $Consumer_<$AdvancementHolder>, typesRequired: $List_<$EntityType<never>>): $AdvancementHolder;
    ...
    export class $VanillaHusbandryAdvancements implements $AdvancementSubProvider {
        generate(registries: $HolderLookup$Provider, writer: $Consumer_<$AdvancementHolder>): void;
        static createBreedAllAnimalsAdvancement(parent: $AdvancementHolder_, writer: $Consumer_<$AdvancementHolder>, breedableAnimals: $Stream<$EntityType<never>>, indirectlyBreedableAnimals: $Stream<$EntityType<never>>): $AdvancementHolder;
