...
declare module "@package/net/minecraft/data" {
    ...
    export class $BlockFamily$Builder {
        fence(buttonBlock: $Block): $BlockFamily$Builder;
        sign(signBlock: $Block, wallSignBlock: $Block): $BlockFamily$Builder;
        wall(buttonBlock: $Block): $BlockFamily$Builder;
        getFamily(): $BlockFamily;
        polished(buttonBlock: $Block): $BlockFamily$Builder;
        chiseled(buttonBlock: $Block): $BlockFamily$Builder;
        cut(buttonBlock: $Block): $BlockFamily$Builder;
        cracked(buttonBlock: $Block): $BlockFamily$Builder;
        ...
        button(buttonBlock: $Block): $BlockFamily$Builder;
        stairs(buttonBlock: $Block): $BlockFamily$Builder;
        fenceGate(buttonBlock: $Block): $BlockFamily$Builder;
        door(buttonBlock: $Block): $BlockFamily$Builder;
        slab(buttonBlock: $Block): $BlockFamily$Builder;
        trapdoor(buttonBlock: $Block): $BlockFamily$Builder;
        pressurePlate(buttonBlock: $Block): $BlockFamily$Builder;
        mosaic(buttonBlock: $Block): $BlockFamily$Builder;
        customFence(buttonBlock: $Block): $BlockFamily$Builder;
        customFenceGate(buttonBlock: $Block): $BlockFamily$Builder;
    ...
    export class $BlockFamilies {
        ...
        static familyBuilder(baseBlock: $Block): $BlockFamily$Builder;
