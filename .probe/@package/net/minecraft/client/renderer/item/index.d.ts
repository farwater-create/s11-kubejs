...
declare module "@package/net/minecraft/client/renderer/item" {
    ...
    export class $ItemProperties {
        ...
        static register(arg0: $Item, arg1: $ResourceLocation_, arg2: $ItemPropertyFunction_): void;
        static register(item: $Item, name: $ResourceLocation_, property: $ClampedItemPropertyFunction_): void;
