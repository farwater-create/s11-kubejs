...
import { $PalettedPermutationsAccessor } from "@package/net/orcinus/galosphere/mixin";
...
declare module "@package/net/minecraft/client/renderer/texture/atlas/sources" {
    ...
    export class $PalettedPermutations implements $SpriteSource, $PalettedPermutationsAccessor {
        run(resourceManager: $ResourceManager, output: $SpriteSource$Output): void;
        type(): $SpriteSourceType;
