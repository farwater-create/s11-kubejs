...
declare module "@package/net/minecraft/client/gui/screens/social" {
    ...
    export class $PlayerSocialManager {
        ...
        handler$bkb000$supplementaries$supp$removePlayer(arg0: $UUID_, arg1: $CallbackInfo): void;
        handler$bkb000$supplementaries$supp$getPlayer(arg0: $PlayerInfo, arg1: $CallbackInfo): void;
