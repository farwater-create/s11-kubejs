...
import { $SculkChargeParticleOptions, $ParticleGroup, $VibrationParticleOption, $BlockParticleOption, $ParticleOptions, $ColorParticleOption, $SimpleParticleType, $ScalableParticleOptionsBase, $DustParticleOptions, $SculkChargeParticleOptions_, $ParticleOptions_, $DustColorTransitionOptions, $ItemParticleOption, $ShriekParticleOption, $ParticleType } from "@package/net/minecraft/core/particles";
...
declare module "@package/net/minecraft/client/particle" {
    ...
    export class $FlameParticle extends $RisingParticle implements $ParticleExtension {
        wrapMethod$hge000$sable$move(arg0: number, arg1: number, arg2: number, arg3: $Operation_<any>): void;
        speedUpWhenYMotionIsBlocked: boolean;
        lifetime: number;
        roll: number;
        yd: number;
    ...
    export class $SingleQuadParticle extends $Particle {
        handler$dhg000$sodium$render(arg0: $VertexConsumer, arg1: $Camera, arg2: number, arg3: $CallbackInfo): void;
        ...
        handler$dhg000$sodium$renderRotatedQuad(arg0: $VertexConsumer, arg1: $Camera, arg2: $Quaternionf, arg3: number, arg4: $CallbackInfo): void;
    ...
    export class $DripParticle extends $TextureSheetParticle {
        ...
        bbWidth: number;
        age: number;
        constructor(level: $ClientLevel, x: number, arg2: number, y: number, arg4: $Fluid);
        get type(): $Fluid;
    }
    ...
    export class $ParticleEngine implements $PreparableReloadListener, $ParticleEngineAccessor$1, $ParticleManagerAccessor, $ParticleManagerAccess, $ParticleEngineAccessor {
         ...
         * @deprecated
         */
        register<T extends $ParticleOptions>(particleType: $ParticleType<T>, particleMetaFactory: $ParticleEngine$SpriteParticleRegistration_<T>): void;
        /**
         * @deprecated
         */
        register<T extends $ParticleOptions>(particleType: $ParticleType<T>, sprite: $ParticleProvider$Sprite_<T>): void;
        /**
         * @deprecated
         */
        register<T extends $ParticleOptions>(particleType: $ParticleType<T>, particleFactory: $ParticleProvider_<T>): void;
        ...
        handler$bbi002$veil$tick(arg0: $CallbackInfo): void;
        handler$jjj000$axiom$crack(blockPos: $BlockPos_, direction: $Direction_, ci: $CallbackInfo): void;
        handler$bbi000$veil$clear(arg0: $CallbackInfo): void;
        handler$blg000$ldlib2$injectTick(arg0: $CallbackInfo): void;
        handler$bbi000$veil$countParticles(arg0: $CallbackInfoReturnable<any>): void;
        handler$bbi000$veil$setLevel(arg0: $ClientLevel, arg1: $CallbackInfo): void;
