...
import { $HumanoidArm, $Pose, $PortalProcessor, $PlayerRideableJumping, $Entity, $MoverType_, $EntityDimensions, $Entity$RemovalReason, $WalkAnimationState } from "@package/net/minecraft/world/entity";
...
import { $PlayerAccessor } from "@package/forge/me/thosea/badoptimizations/mixin/accessors";
...
declare module "@package/net/minecraft/client/player" {
    export class $LocalPlayer extends $AbstractClientPlayer implements $IQuiverPlayer, $LocalClientPlayerKJS, $PlayerFreezeExtension, $PlayerAccessor {
        drop(fullStack: boolean): boolean;
        handler$eae000$xaerominimap$onTickStart(arg0: $CallbackInfo): void;
        handler$jck000$parcool$onIsShiftKeyDown(arg0: $CallbackInfoReturnable<any>): void;
        /**
         * Returns whether the entity is in a server world
         */
        shouldShowDeathScreen(): boolean;
        wrapOperation$bnf001$vista$suppl$preventMovementWhileOperatingCannon(arg0: $Input, arg1: boolean, arg2: number, arg3: $Operation_<any>): void;
        wrapOperation$bjj000$supplementaries$suppl$preventMovementWhileOperatingCannon(arg0: $Input, arg1: boolean, arg2: number, arg3: $Operation_<any>): void;
        getStatsCounter(): $StatsCounter;
        handler$jck003$parcool$onMove(arg0: $MoverType_, arg1: $Vec3_, arg2: $CallbackInfo): void;
    ...
    export class $AbstractClientPlayer extends $Player implements $AbstractClientPlayerAccessor, $ClientPlayerKJS, $ACPExtension {
        handler$jbo000$create_sa$getSkinMixin(arg0: $CallbackInfoReturnable<any>): void;
        /**
         * Returns the amount of health added by the Absorption effect.
         */
