import { $Keyable, $Decoder$Simple, $DataResult, $DynamicOps, $Codec, $MapLike, $ListBuilder, $Decoder$Boxed, $Lifecycle, $Encoder, $RecordBuilder$AbstractUniversalBuilder, $Dynamic, $MapCodec, $Decoder, $Codec$ResultFunction, $Encoder_, $RecordBuilder, $Decoder$Terminal, $Decoder_ } from "@package/com/mojang/serialization";
...
import { $EntityType, $Mob, $MobSpawnType_ } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/minecraft/util" {
    ...
    export class $SimpleBitStorage implements $BitStorage, $CompactingPackedIntegerArray, $BitStorageExtension {
        ...
        redirect$ckp000$lithium$skipValidation(arg0: number, arg1: number, arg2: number): void;
    ...
    export class $SpawnUtil {
        static trySpawnMob<T extends $Mob>(entityType: $EntityType<T>, spawnType: $MobSpawnType_, level: $ServerLevel, pos: $BlockPos_, attempts: number, spread: number, yOffset: number, strategy: $SpawnUtil$Strategy_): (T) | undefined;
        constructor();
    }
    ...
    export class $ExtraCodecs {
        ...
        static orCompressed<E>(first: $MapCodec<E>, second: $MapCodec<E>): $MapCodec<E>;
        ...
        static asOptionalLong(codec: $MapCodec<(number) | undefined>): $MapCodec<$OptionalLong>;
    ...
    export class $KeyDispatchDataCodec<A> extends $Record {
        static of<A>(codec: $MapCodec<A>): $KeyDispatchDataCodec<A>;
        codec(): $MapCodec<A>;
        constructor(arg0: $MapCodec<A>);
    }
    /**
     * Values that may be interpreted as {@link $KeyDispatchDataCodec}.
     */
    export type $KeyDispatchDataCodec_<A> = { codec?: $MapCodec<any>,  } | [codec?: $MapCodec<any>, ];
    ...
    export class $ClassInstanceMultiMap<T> extends $AbstractCollection<T> implements $ClassInstanceMultiMapAccessor<any>, $ClassGroupFilterableList<any>, $TypeFilterableListInternalAccess<any> {
        ...
        localvar$ckm000$lithium$add(arg0: $Object): $Object;
        localvar$ckm000$lithium$remove(arg0: $Object): $Object;
    ...
    export class $ParticleUtils {
        static spawnParticleBelow(level: $Level, pos: $BlockPos_, random: $RandomSource, particle: $ParticleOptions_): void;
        ...
        static spawnParticlesOnBlockFace(level: $Level, pos: $BlockPos_, particle: $ParticleOptions_, count: $IntProvider_, direction: $Direction_, speedSupplier: $Supplier_<$Vec3>, spread: number): void;
        static spawnParticleInBlock(level: $LevelAccessor, pos: $BlockPos_, count: number, particle: $ParticleOptions_): void;
        static spawnParticleOnFace(level: $Level, pos: $BlockPos_, direction: $Direction_, particle: $ParticleOptions_, speed: $Vec3_, spread: number): void;
        static spawnParticlesOnBlockFaces(level: $Level, pos: $BlockPos_, particle: $ParticleOptions_, count: $IntProvider_): void;
        static spawnParticlesAlongAxis(axis: $Direction$Axis_, level: $Level, pos: $BlockPos_, spread: number, arg4: $ParticleOptions_, particle: $UniformInt): void;
        constructor();
    }
     ...
     */
    export type $CubicSpline$Multipoint_<C, I> = { minValue?: number, coordinate?: $ToFloatFunction<C>, values?: $List_<$CubicSpline<any, $ToFloatFunction<C>>>, derivatives?: number[], maxValue?: number, locations?: number[],  } | [minValue?: number, coordinate?: $ToFloatFunction<C>, values?: $List_<$CubicSpline<any, $ToFloatFunction<C>>>, derivatives?: number[], maxValue?: number, locations?: number[], ];
    ...
    export class $ZeroBitStorage implements $BitStorage, $BitStorageExtension {
        ...
        getBits(): number;
        getAll(consumer: $IntConsumer_): void;
        redirect$cla001$lithium$skipValidation(arg0: number, arg1: number, arg2: number): void;
        unpack(array: number[]): void;
        /**
         * Gets the long array that is used to store the data in this BitArray. This is useful for sending packet data.
         */
