...
declare module "@package/net/minecraft/util/valueproviders" {
    ...
    export class $FloatProviderType<P extends $FloatProvider> {
        static register<P extends $FloatProvider>(name: string, codec: $MapCodec<P>): $FloatProviderType<P>;
     ...
     */
    export type $FloatProviderType_<P> = (() => $MapCodec<P>);
    export class $IntProviderType<P extends $IntProvider> {
        static register<P extends $IntProvider>(name: string, codec: $MapCodec<P>): $IntProviderType<P>;
     ...
     */
    export type $IntProviderType_<P> = (() => $MapCodec<P>);
