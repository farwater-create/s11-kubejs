...
declare module "@package/net/minecraft/stats" {
    ...
    export class $StatsCounter {
        getValue<T>(type: $StatType<T>, value: T): number;
    ...
    export class $Stat<T> extends $ObjectiveCriteria {
         ...
         */
        static buildName<T>(type: $StatType<T>, value: T): string;
        ...
        constructor(type: $StatType<T>, value: T, formatter: $StatFormatter_);
        get value(): T;
        get type(): $StatType<T>;
    }
    /**
