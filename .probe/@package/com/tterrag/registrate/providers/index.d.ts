import { $Recipe, $AbstractCookingRecipe$Factory_, $RecipeSerializer, $AbstractCookingRecipe } from "@package/net/minecraft/world/item/crafting";
...
import { $CreativeModeTab, $Item } from "@package/net/minecraft/world/item";
...
declare module "@package/com/tterrag/registrate/providers" {
    ...
    export class $RegistrateLangProvider extends $LanguageProvider implements $RegistrateProvider {
        add(arg0: $CreativeModeTab, arg1: string): void;
    ...
    export class $RegistrateBlockstateProvider extends $BlockStateProvider implements $RegistrateProvider {
        getExistingVariantBuilder(arg0: $Block): ($VariantBlockStateBuilder) | undefined;
        getSide(): $LogicalSide;
        getExistingMultipartBuilder(arg0: $Block): ($MultiPartBlockStateBuilder) | undefined;
     ...
     */
    export type $RegistrateGenericProvider$GeneratorData_ = { registries?: $CompletableFuture<$HolderLookup$Provider>, output?: $PackOutput, existingFileHelper?: $ExistingFileHelper,  } | [registries?: $CompletableFuture<$HolderLookup$Provider>, output?: $PackOutput, existingFileHelper?: $ExistingFileHelper, ];
    export class $RegistrateRecipeProvider extends $RecipeProvider implements $RegistrateProvider, $RecipeOutput {
        ...
        cooking<T extends $ItemLike, S extends $AbstractCookingRecipe>(arg0: $DataIngredient, arg1: $RecipeCategory_, arg2: $Supplier_<T>, arg3: number, arg4: number, arg5: string, arg6: $RecipeSerializer<S>, arg7: $AbstractCookingRecipe$Factory_<S>): void;
        cooking<T extends $ItemLike, S extends $AbstractCookingRecipe>(arg0: $DataIngredient, arg1: $RecipeCategory_, arg2: $Supplier_<T>, arg3: number, arg4: number, arg5: $RecipeSerializer<S>, arg6: $AbstractCookingRecipe$Factory_<S>): void;
