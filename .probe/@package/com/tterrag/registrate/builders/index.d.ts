...
import { $BlockEntry, $FluidEntry, $EntityEntry, $RegistryEntry, $MenuEntry, $ItemEntry, $BlockEntityEntry } from "@package/com/tterrag/registrate/util/entry";
...
declare module "@package/com/tterrag/registrate/builders" {
     ...
     */
    export type $FluidBuilder$FluidTypeFactory_ = ((arg0: $FluidType$Properties, arg1: $ResourceLocation, arg2: $ResourceLocation) => $FluidType);
    ...
    export interface $MenuBuilder$MenuFactory<T extends $AbstractContainerMenu> {
        create(arg0: $MenuType<T>, arg1: number, arg2: $Inventory): T;
    }
    /**
    ...
    export interface $MenuBuilder$ForgeMenuFactory<T extends $AbstractContainerMenu> {
        create(arg0: $MenuType<T>, arg1: number, arg2: $Inventory, arg3: $RegistryFriendlyByteBuf | null): T;
    }
    /**
    ...
    export interface $BlockEntityBuilder$BlockEntityFactory<T extends $BlockEntity> {
        create(arg0: $BlockEntityType<T>, arg1: $BlockPos_, arg2: $BlockState_): T;
    }
    /**
