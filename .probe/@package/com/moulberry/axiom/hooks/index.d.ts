import { $CreativeModeTab, $ItemStack_ } from "@package/net/minecraft/world/item";
...
declare module "@package/com/moulberry/axiom/hooks" {
    ...
    export interface $CreativeModeInventoryScreenExt {
        axiom$checkTabClicked(arg0: $CreativeModeTab, arg1: number, arg2: number): boolean;
        axiom$renderTabButton(arg0: $GuiGraphics, arg1: number, arg2: number, arg3: $CreativeModeTab, arg4: boolean): void;
        axiom$checkTabHovering(arg0: $GuiGraphics, arg1: $CreativeModeTab, arg2: number, arg3: number): boolean;
        axiom$selectTab(arg0: $CreativeModeTab): void;
    }
