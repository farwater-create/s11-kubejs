...
declare module "@package/com/simibubi/create/api/contraption/storage/fluid" {
    export class $MountedFluidStorageType<T extends $MountedFluidStorage> {
        ...
        static mountedFluidStorage<B extends $Block, P>(arg0: $RegistryEntry<$MountedFluidStorageType<never>, $MountedFluidStorageType<never>>): $NonNullUnaryOperator<$BlockBuilder<B, P>>;
        codec: $MapCodec<T>;
