...
declare module "@package/com/simibubi/create/api/event" {
    export class $BlockEntityBehaviourEvent extends $Event {
        ...
        forType<T extends $SmartBlockEntity>(arg0: $BlockEntityType<T>, arg1: $Consumer_<T>): void;
    ...
    export class $PipeCollisionEvent$Spill extends $PipeCollisionEvent {
        getWorldFluid(): $Fluid;
        getPipeFluid(): $Fluid;
        constructor(arg0: $Level, arg1: $BlockPos_, arg2: $Fluid, arg3: $Fluid, arg4: $BlockState_);
