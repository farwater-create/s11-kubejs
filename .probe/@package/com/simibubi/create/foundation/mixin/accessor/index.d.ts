...
import { $EquipmentSlot_, $EntityType } from "@package/net/minecraft/world/entity";
...
declare module "@package/com/simibubi/create/foundation/mixin/accessor" {
    ...
    export interface $FlowingFluidAccessor {
        create$getNewLiquid(arg0: $Level, arg1: $BlockPos_, arg2: $BlockState_): $FluidState;
    }
    /**
    ...
    export class $FallingBlockEntityAccessor {
        static create$callInit(arg0: $Level, arg1: number, arg2: number, arg3: number, arg4: $BlockState_): $FallingBlockEntity;
    }
    ...
    export interface $DispenserBlockAccessor {
        create$callGetDispenseMethod(arg0: $Level, arg1: $ItemStack_): $DispenseItemBehavior;
    }
    /**
     ...
     */
    export type $ConcretePowderBlockAccessor_ = (() => $Block);
     ...
     */
    export type $EntityRenderDispatcherAccessor_ = (() => $Map_<$EntityType<never>, $EntityRenderer<never>>);
}
