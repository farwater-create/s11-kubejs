...
import { $Decoder, $Keyable_, $Decoder$Simple, $Codec$ResultFunction, $DataResult, $MapEncoder, $DynamicOps, $MapLike, $Codec, $Decoder$Boxed, $Lifecycle, $Dynamic, $RecordBuilder, $MapCodec, $Encoder, $Decoder$Terminal, $MapDecoder } from "@package/com/mojang/serialization";
...
declare module "@package/com/mojang/serialization/codecs" {
    ...
    export class $RecordCodecBuilder<O, F> implements $App<$RecordCodecBuilder$Mu<O>, F> {
        static of<O, F>(arg0: $Function_<O, F>, arg1: $MapCodec<F>): $RecordCodecBuilder<O, F>;
