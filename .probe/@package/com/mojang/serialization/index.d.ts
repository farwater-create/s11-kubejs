...
declare module "@package/com/mojang/serialization" {
    ...
    export class $MapCodec<A> extends $CompressorHolder implements $MapDecoder<A>, $MapEncoder<A> {
        ...
        dependent<E>(arg0: $MapCodec<E>, arg1: $Function_<A, $Pair<E, $MapCodec<E>>>, arg2: $BiFunction_<A, E, A>): $MapCodec<A>;
    ...
    export class $Codec<A> {
        ...
        static mapEither<F, S>(arg0: $MapCodec<F>, arg1: $MapCodec<S>): $MapCodec<$Either<F, S>>;
        static mapPair<F, S>(arg0: $MapCodec<F>, arg1: $MapCodec<S>): $MapCodec<$Pair<F, S>>;
