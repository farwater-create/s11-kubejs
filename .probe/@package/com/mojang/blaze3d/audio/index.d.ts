...
declare module "@package/com/mojang/blaze3d/audio" {
    ...
    export class $Channel implements $Blaze3DAudioChannelAccessor, $ChannelAccessor {
        ...
        handler$zic000$etched$play(arg0: $CallbackInfo): void;
        handler$zic000$etched$stop(arg0: $CallbackInfo): void;
        pumpBuffers(source: number): void;
        handler$zic000$etched$stopped(arg0: $CallbackInfoReturnable<any>): void;
        handler$zic000$etched$attachBufferStream(arg0: $CallbackInfo): void;
        handler$zic000$etched$attachStaticBuffer(arg0: $CallbackInfo): void;
        /**
