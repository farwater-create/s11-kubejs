...
import { $TestDartAccess } from "@package/com/addon/gancho";
import { $Vec3 } from "@package/net/minecraft/world/phys";
import { $EntityInLevelCallback } from "@package/net/minecraft/world/level/entity";

declare module "@package/dev/simulated_team/simulated/content/entities/launched_plunger" {
    export class $LaunchedPlungerEntity extends $ThrowableProjectile implements $TestDartAccess {
        static create(arg0: $EntityType<$LaunchedPlungerEntity>, arg1: $Level): $LaunchedPlungerEntity;
        getTarget(): $Vec3;
        getData<T>(arg0: $EntityDataAccessor_<T>): T;
        setData<T>(arg0: $EntityDataAccessor_<T>, arg1: T): void;
        addonGancho$isTestDart(): boolean;
        addonGancho$isOffHandHook(): boolean;
        getClientSmoothedVelocity(arg0: number): $Vec3;
        addonGancho$isSwingDart(): boolean;
        ...
        constructor(arg0: $EntityType<$LaunchedPlungerEntity>, arg1: $Level);
        get target(): $Vec3;
        get plunged(): boolean;
