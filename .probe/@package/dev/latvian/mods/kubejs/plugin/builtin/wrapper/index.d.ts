...
import { $CreativeModeTab, $Item, $DyeColor, $ItemStack_, $ItemStack } from "@package/net/minecraft/world/item";
...
declare module "@package/dev/latvian/mods/kubejs/plugin/builtin/wrapper" {
    ...
    export class $BlockWrapper {
        ...
        static registerBuildingMaterial(event: $RegistryKubeEvent<$Block>, id: $ResourceLocation_): void;
        static registerBuildingMaterial(event: $RegistryKubeEvent<$Block>, id: $ResourceLocation_, properties: $BuildingMaterialProperties_): void;
        /**
    ...
    export class $ItemWrapper {
         ...
         */
        static getId(item: $Item): $ResourceLocation;
        /**
