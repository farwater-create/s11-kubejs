...
import { $DataResult, $DynamicOps, $Codec, $MapCodec, $MapLike } from "@package/com/mojang/serialization";
...
import { $CreativeModeTab, $Item, $ItemStack_, $ItemStack } from "@package/net/minecraft/world/item";
...
declare module "@package/dev/latvian/mods/kubejs/util" {
    ...
    export class $Tags {
        ...
        static byEntityType(entityType: $EntityType<never>): $Stream<$TagKey<$EntityType<never>>>;
        constructor();
    }
     ...
     */
    export type $ModResourceBindings$ClassBindingProvider_ = { className?: string, filter?: $ScriptTypePredicate_, name?: string,  } | [className?: string, filter?: $ScriptTypePredicate_, name?: string, ];
    ...
    export class $OpsContainer {
        ...
        decodeMap<T>(codec: $MapCodec<T>, o: $Object): T;
        nbt(): $DynamicOps<$Tag>;
        static DEFAULT: $OpsContainer;
