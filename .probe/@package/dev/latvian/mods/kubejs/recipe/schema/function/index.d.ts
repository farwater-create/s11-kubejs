...
import { $DataResult, $MapCodec, $DynamicOps, $Codec } from "@package/com/mojang/serialization";
...
declare module "@package/dev/latvian/mods/kubejs/recipe/schema/function" {
    ...
    export class $RecipeSchemaFunctionType<T extends $RecipeSchemaFunction> extends $Record {
        ...
        constructor(id: string, mapCodec: $MapCodec<T>);
    }
    /**
     * Values that may be interpreted as {@link $RecipeSchemaFunctionType}.
     */
    export type $RecipeSchemaFunctionType_<T> = { id?: string, mapCodec?: $MapCodec<$RecipeSchemaFunction>,  } | [id?: string, mapCodec?: $MapCodec<$RecipeSchemaFunction>, ];
