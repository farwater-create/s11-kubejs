...
declare module "@package/dev/latvian/mods/kubejs/recipe/ingredientaction" {
    ...
    export class $IngredientActionType<T extends $IngredientAction> extends $Record {
        ...
        constructor(id: $ResourceLocation_, codec: $MapCodec<T>);
        constructor(id: $ResourceLocation_, codec: $MapCodec<T>, streamCodec: $StreamCodec<$RegistryFriendlyByteBuf, T>);
    }
    /**
     * Values that may be interpreted as {@link $IngredientActionType}.
     */
    export type $IngredientActionType_<T> = { streamCodec?: $StreamCodec<$RegistryFriendlyByteBuf, $IngredientAction>, codec?: $MapCodec<$IngredientAction>, id?: $ResourceLocation_,  } | [streamCodec?: $StreamCodec<$RegistryFriendlyByteBuf, $IngredientAction>, codec?: $MapCodec<$IngredientAction>, id?: $ResourceLocation_, ];
