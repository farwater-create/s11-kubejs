...
declare module "@package/dev/latvian/mods/kubejs/recipe/viewer/server" {
    ...
    export class $FluidData$DataComponentSubtypes extends $Record {
        ...
        constructor(filter: $FluidIngredient_, components: $List_<$DataComponentType<never>>);
    }
    /**
     * Values that may be interpreted as {@link $FluidData$DataComponentSubtypes}.
     */
    export type $FluidData$DataComponentSubtypes_ = { filter?: $FluidIngredient_, components?: $List_<$DataComponentType<never>>,  } | [filter?: $FluidIngredient_, components?: $List_<$DataComponentType<never>>, ];
    ...
    export class $ItemData$DataComponentSubtypes extends $Record {
        ...
        constructor(filter: $Ingredient_, components: $List_<$DataComponentType<never>>);
    }
    /**
     * Values that may be interpreted as {@link $ItemData$DataComponentSubtypes}.
     */
    export type $ItemData$DataComponentSubtypes_ = { filter?: $Ingredient_, components?: $List_<$DataComponentType<never>>,  } | [filter?: $Ingredient_, components?: $List_<$DataComponentType<never>>, ];
    ...
    export class $ServerRegisterFluidSubtypesKubeEvent implements $RegisterSubtypesKubeEvent {
        ...
        useComponents(filter: $Object, components: $List_<$DataComponentType<never>>): void;
