import { $Level, $BlockGetter, $Explosion, $LevelAccessor } from "@package/net/minecraft/world/level";
...
import { $Rotation_, $Rotation, $Mirror_, $Block, $Mirror } from "@package/net/minecraft/world/level/block";
...
declare module "@package/dev/latvian/mods/kubejs/block/callback" {
    export class $BlockExplodedCallback {
        ...
        constructor(level: $Level, pos: $BlockPos_, explosion: $Explosion);
        get cause(): $Entity;
    ...
    export class $EntityFallenOnBlockCallback extends $EntityBlockCallback {
        ...
        constructor(level: $Level, entity: $Entity, pos: $BlockPos_, state: $BlockState_, fallHeight: number);
    ...
    export class $EntityBlockCallback {
         ...
         */
        getPos(): $BlockPos;
        constructor(level: $Level, entity: $Entity, pos: $BlockPos_, state: $BlockState_);
        get state(): $BlockState;
        get block(): $LevelBlock;
        get level(): $Level;
        get entity(): $Entity;
