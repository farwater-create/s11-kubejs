...
declare module "@package/dev/latvian/mods/kubejs/block/entity" {
     ...
     */
    export type $BlockEntityAttachmentInfo_ = { index?: number, factory?: $BlockEntityAttachmentFactory_, directions?: $EnumSet<$Direction_>, type?: $BlockEntityAttachmentType_, id?: string,  } | [index?: number, factory?: $BlockEntityAttachmentFactory_, directions?: $EnumSet<$Direction_>, type?: $BlockEntityAttachmentType_, id?: string, ];
