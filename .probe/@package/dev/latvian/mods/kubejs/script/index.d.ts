...
declare module "@package/dev/latvian/mods/kubejs/script" {
    ...
    export class $MapCodecTypeWrapper<T> extends $Record implements $TypeWrapperFactory<T> {
        ...
        defaultValue(): T;
        codec(): $MapCodec<T>;
        constructor(target: $Class<T>, codec: $MapCodec<T>, defaultValue: T);
    }
    /**
     * Values that may be interpreted as {@link $MapCodecTypeWrapper}.
     */
    export type $MapCodecTypeWrapper_<T> = { defaultValue?: any, codec?: $MapCodec<any>, target?: $Class<any>,  } | [defaultValue?: any, codec?: $MapCodec<any>, target?: $Class<any>, ];
    ...
    export interface $DataComponentTypeInfoRegistry {
        register(type: $DataComponentType<never>, typeInfo: $TypeInfo_): void;
