...
import { $VillagerType, $VillagerProfession_ } from "@package/net/minecraft/world/entity/npc";
...
declare module "@package/dev/latvian/mods/kubejs/script/data" {
    ...
    export class $VirtualDataPack extends $VirtualResourcePack implements $KubeDataGenerator {
        ...
        setParrotImitation(type: $EntityType<never>, sound: $SoundEvent): void;
        ...
        setVillagerType(biome: $ResourceKey_<$Biome>, villagerType: $VillagerType): void;
        setMonsterRoomMobs(entityType: $EntityType<never>, weight: number): void;
