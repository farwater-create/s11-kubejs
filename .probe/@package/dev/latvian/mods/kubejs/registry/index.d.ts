...
declare module "@package/dev/latvian/mods/kubejs/registry" {
     ...
     */
    export type $RegistryType_<T> = { key?: $ResourceKey_<$Registry<any>>, type?: $TypeInfo_, baseClass?: $Class<never>,  } | [key?: $ResourceKey_<$Registry<any>>, type?: $TypeInfo_, baseClass?: $Class<never>, ];
