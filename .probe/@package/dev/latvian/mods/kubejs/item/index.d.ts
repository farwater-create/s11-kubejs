...
import { $DataComponentType, $DataComponentMap, $DataComponentMap_, $DataComponentPatch_, $DataComponentPatch } from "@package/net/minecraft/core/component";
...
import { $Item, $UseAnim_, $Item$Properties, $Rarity_, $JukeboxSong, $TooltipFlag, $ArmorMaterial, $DyeColor_, $Tier_, $ItemStack_, $ItemStack, $Instrument, $ArmorItem$Type_, $Tier, $ArmorMaterial$Layer } from "@package/net/minecraft/world/item";
...
declare module "@package/dev/latvian/mods/kubejs/item" {
    ...
    export class $ItemStackKey {
        ...
        constructor(item: $Item, patch: $DataComponentPatch_);
    }
    ...
    export interface $ItemBuilder$FinishUsingCallback {
        finishUsingItem(itemStack: $ItemStack_, level: $Level, livingEntity: $LivingEntity): $ItemStack;
    }
    /**
    ...
    export interface $ItemBuilder$ReleaseUsingCallback {
        releaseUsing(itemStack: $ItemStack_, level: $Level, user: $LivingEntity, tick: number): void;
    }
    /**
    ...
    export class $ItemModificationKubeEvent$ItemModifications extends $Record implements $ItemComponentFunctions {
        ...
        setCraftingRemainder(item: $Item): void;
     ...
     */
    export type $ItemModificationKubeEvent$ItemModifications_ = { item?: $Item,  } | [item?: $Item, ];
    ...
    export interface $ItemBuilder$UseCallback {
        use(level: $Level, player: $Player, interactionHand: $InteractionHand_): boolean;
    }
    /**
