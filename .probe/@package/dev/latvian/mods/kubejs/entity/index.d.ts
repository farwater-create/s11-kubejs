...
import { $Attribute, $Attribute$Sentiment_ } from "@package/net/minecraft/world/entity/ai/attributes";
...
declare module "@package/dev/latvian/mods/kubejs/entity" {
    ...
    export class $CheckLivingEntitySpawnKubeEvent implements $KubeLivingEntityEvent {
        ...
        y: number;
        z: number;
        constructor(entity: $LivingEntity, level: $Level, x: number, y: number, z: number, type: $MobSpawnType_, spawnerEither: $Either<$BlockEntity, $Entity>);
    ...
    export class $LivingEntityDeathKubeEvent implements $KubeLivingEntityEvent {
         ...
         * The `player` and `getPlayer` casts the entity to `Player` and return null if the cast fails. Check for `DamageSource` to find the source of damage.
         */
        /**
