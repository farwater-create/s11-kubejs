...
declare module "@package/dev/latvian/mods/kubejs/fluid" {
    ...
    export class $FluidTypeBuilder extends $BuilderBase<$FluidType> {
        ...
        addDripstoneDripping(chance: number, dripParticle: $ParticleOptions_, cauldron: $Block, fillSound: $SoundEvent): this;
        ...
        sound(action: $SoundAction, sound: $SoundEvent): this;
    ...
    export class $FluidWrapper {
        ...
        static getId(fluid: $Fluid): $ResourceLocation;
