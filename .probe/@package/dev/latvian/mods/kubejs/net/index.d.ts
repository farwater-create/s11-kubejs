...
declare module "@package/dev/latvian/mods/kubejs/net" {
     ...
     */
    export type $RequestInventoryKubedexPayload_ = { flags?: number, slots?: $List_<number>, stacks?: $List_<$ItemStack_>,  } | [flags?: number, slots?: $List_<number>, stacks?: $List_<$ItemStack_>, ];
     ...
     */
    export type $DisplayServerErrorsPayload_ = { errors?: $List_<$ConsoleLine>, scriptType?: number, warnings?: $List_<$ConsoleLine>,  } | [errors?: $List_<$ConsoleLine>, scriptType?: number, warnings?: $List_<$ConsoleLine>, ];
