...
import { $Recipe, $RecipeHolder, $RecipeType as $RecipeType$1 } from "@package/net/minecraft/world/item/crafting";
...
declare module "@package/mezz/jei/api/recipe" {
    ...
    export class $RecipeType<T> {
        ...
        static createFromVanilla<R extends $Recipe<never>>(arg0: $RecipeType$1<R>): $RecipeType<$RecipeHolder<R>>;
