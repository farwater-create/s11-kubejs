...
declare module "@package/it/unimi/dsi/fastutil/booleans" {
    ...
    export interface $BooleanSpliterator extends $Spliterator$OfPrimitive<boolean, $BooleanConsumer, $BooleanSpliterator> {
        ...
        getComparator(): $BooleanComparator;
        get comparator(): $BooleanComparator;
    }
    ...
    export interface $BooleanComparator extends $Comparator<boolean> {
        ...
        thenComparing(arg0: $Comparator<boolean>): $Comparator<boolean>;
        thenComparing(arg0: $BooleanComparator): $BooleanComparator;
    }
     ...
     */
    export type $BooleanIterable_ = (() => $BooleanIterator);
