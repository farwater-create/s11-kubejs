...
import { $Spliterator$OfInt, $SortedMap, $Map, $Map$Entry, $ListIterator, $List, $Collection_, $List_, $Collection, $SortedSet, $Comparator, $Set, $RandomAccess, $Iterator, $PrimitiveIterator$OfInt, $AbstractCollection } from "@package/java/util";
...
declare module "@package/it/unimi/dsi/fastutil/ints" {
     ...
     */
    export type $IntIterable_ = (() => $IntIterator);
    ...
    export interface $IntConsumer extends $Consumer<number>, $IntConsumer$1 {
        ...
        andThen(arg0: $IntConsumer_$1): $IntConsumer;
        /**
         * @deprecated
         */
