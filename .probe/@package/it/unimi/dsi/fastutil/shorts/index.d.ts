...
import { $PrimitiveIterator, $Map, $Map$Entry, $ListIterator, $List, $Collection, $Comparator, $Set, $Spliterator$OfPrimitive } from "@package/java/util";
...
declare module "@package/it/unimi/dsi/fastutil/shorts" {
    ...
    export interface $ShortPredicate extends $Predicate<number>, $IntPredicate {
        ...
        and(arg0: $IntPredicate_): $ShortPredicate;
    ...
    export interface $ShortConsumer extends $Consumer<number>, $IntConsumer {
        ...
        andThen(arg0: $IntConsumer_): $ShortConsumer;
     ...
     */
    export type $ShortIterable_ = (() => $ShortIterator);
    ...
    export interface $ShortSpliterator extends $Spliterator$OfPrimitive<number, $ShortConsumer, $ShortSpliterator> {
        ...
        getComparator(): $ShortComparator;
        get comparator(): $ShortComparator;
    }
