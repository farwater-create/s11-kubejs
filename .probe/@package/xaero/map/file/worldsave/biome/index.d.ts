...
import { $BiomeManager, $BiomeManager$NoiseBiomeSource, $Biome } from "@package/net/minecraft/world/level/biome";
...
declare module "@package/xaero/map/file/worldsave/biome" {
    export class $WorldDataBiomeManager implements $BiomeManager$NoiseBiomeSource {
        ...
        resetChunkBiomeData(arg0: number, arg1: number, arg2: $Biome, arg3: $Registry<$Biome>): void;
